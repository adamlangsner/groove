(function(a, d) {
    ...
    function k(h, l, n) {
        ...
        if (m.isFunction(l)) return m.grep(h, function(u, z) {
            ...
            if (pb.test(l)) return m.filter(l, p, !n);
            else l = m.filter(l, p)
        }
    ...
    function s(h, l) {
        if (!(l.nodeType !== 1 || !m.hasData(h))) {
            ...
            if (D) {
                ...
                for (n in D) {
                    p = 0;
                    for (u = D[n].length; p < u; p++) m.event.add(l, n + (D[n][p].namespace ? "." : "") + D[n][p].namespace, D[n][p], D[n][p].data)
                }
            }
    ...
    function q(h, l) {
        ...
        if (l.nodeType === 1) {
            ...
            if (n === "object") l.outerHTML = h.outerHTML;
            else if (n === "input" && (h.type === "checkbox" || h.type === "radio")) {
                if (h.checked) l.defaultChecked = l.checked = h.checked;
                if (l.value !== h.value) l.value = h.value
            } else if (n === "option") l.selected = h.defaultSelected;
            else if (n === "input" || n === "textarea") l.defaultValue = h.defaultValue;
    ...
    function t(h) {
        ...
        if (l === "input") v(h);
        else l !== "script" && typeof h.getElementsByTagName !== "undefined" && m.grep(h.getElementsByTagName("input"), v)
    }
    function y(h, l) {
        l.src ? m.ajax({
            url: l.src,
            async: false,
            dataType: "script"
        }) : m.globalEval((l.text || l.textContent || l.innerHTML || "").replace(ac, "/*$0*/"));
        l.parentNode && l.parentNode.removeChild(l)
    }
    function E(h, l, n) {
        var p = l === "width" ? h.offsetWidth : h.offsetHeight,
            u = l === "width" ? Wb : Jb;
        if (p > 0) {
            n !== "border" && m.each(u, function() {
                n || (p -= parseFloat(m.css(h, "padding" + this)) || 0);
                if (n === "margin") p += parseFloat(m.css(h, n + this)) || 0;
                else p -= parseFloat(m.css(h, "border" + this + "Width")) || 0
            });
            return p + "px"
        }
        p = ab(h, l, l);
    ...
    function B(h, l, n, p, u, z) {
        ...
        z[u] = true;
        u = h[u];
        for (var D = 0, H = u ? u.length : 0, R = h === Za, V; D < H && (R || !V); D++) {
            V = u[D](l, n, p);
            if (typeof V === "string") if (!R || z[V]) V = d;
            else {
    ...
    function ba(h, l, n, p) {
        ...
        else if (!n && l != null && typeof l === "object") for (var u in l) ba(h + "[" + u + "]", l[u], n, p);
        else p(h, l)
    }
    function L() {
        try {
        ...
        if (!Ja[h]) {
            ...
            if (p === "none" || p === "") {
                ...
                if (!qb || !Ea.createElement) {
                    qb = (Ea.contentWindow || Ea.contentDocument).document;
        ...
        m = function() {
            ...
            l.fn = l.prototype = {
                ...
                init: function(I, ha, ia) {
                    ...
                    if (typeof I === "string") if ((oa = I.charAt(0) === "<" && I.charAt(I.length - 1) === ">" && I.length >= 3 ? [null, I, null] : z.exec(I)) && (oa[1] || !ha)) if (oa[1]) {
                        ...
                        this.selector = I;
                        return this
                    } else return !ha || ha.jquery ? (ha || ia).find(I) : this.constructor(ha).find(I);
                    else if (l.isFunction(I)) return ia.ready(I);
                    if (I.selector !== d) {
                ...
                pushStack: function(I, ha, ia) {
                    ...
                    oa.prevObject = this;
                    oa.context = this.context;
                    if (ha === "find") oa.selector = this.selector + (this.selector ? " " : "") + ia;
                    else if (ha) oa.selector = this.selector + "." + ha + "(" + ia + ")";
                    return oa
                },
                each: function(I, ha) {
                ...
                map: function(I) {
                    return this.pushStack(l.map(this, function(ha, ia) {
            ...
            l.extend = l.fn.extend = function() {
                var I, ha, ia, oa, Ca, Ga = arguments[0] || {},
                    Sa = 1,
                    Ta = arguments.length,
                    rb = false;
                ...
                for (; Sa < Ta; Sa++) if ((I = arguments[Sa]) != null) for (ha in I) {
                    ia = Ga[ha];
                    oa = I[ha];
                    if (Ga !== oa) if (rb && oa && (l.isPlainObject(oa) || (Ca = l.isArray(oa)))) {
                        if (Ca) {
                            Ca = false;
            ...
            l.extend({
                ...
                each: function(I, ha, ia) {
                    var oa, Ca = 0,
                        Ga = I.length,
                        Sa = Ga === d || l.isFunction(I);
                    if (ia) if (Sa) for (oa in I) {
                        if (ha.apply(I[oa], ia) === false) break
                    } else for (; Ca < Ga;) {
                ...
                merge: function(I, ha) {
                    var ia = I.length,
                        oa = 0;
                    if (typeof ha.length === "number") for (var Ca = ha.length; oa < Ca; oa++) I[ia++] = ha[oa];
                    else for (; ha[oa] !== d;) I[ia++] = ha[oa++];
                    I.length = ia;
                    return I
                },
                ...
                proxy: function(I, ha) {
                    ...
                    ia.guid = I.guid = I.guid || ia.guid || l.guid++;
                    return ia
                },
        ...
        var l = [],
            ...
            p, u, z, D, H, R = function(ca) {
                ...
                for (ka = ca.length; sa < ka; sa++) {
                    ...
                    Xa = m.type(Ia);
                    if (Xa === "array") R(Ia);
                    else if (Xa === "function") if (!h.unique || !qa.has(Ia)) l.push(Ia)
                }
            },
            V = function(ca, sa) {
                sa = sa || [];
                ...
                u = false;
                if (l) if (h.once) if (p === true) qa.disable();
                else l = [];
                else if (n && n.length) {
                    p = n.shift();
                    qa.fireWith(p[0], p[1])
            ...
            qa = {
                ...
                fireWith: function(ca, sa) {
                    if (n) if (u) h.once || n.push([ca, sa]);
                    else h.once && p || V(ca, sa);
                    return this
                },
                fire: function() {
    ...
    m.extend({
        Deferred: function(h) {
            var l = m.Callbacks("once memory"),
                n = m.Callbacks("once memory"),
                p = m.Callbacks("memory"),
                u = "pending",
                z = {
                    resolve: l,
                    reject: n,
                ...
                D = {
                        ...
                        return m.Deferred(function(sa) {
                            m.each({
                                ...
                                m.isFunction(Xa) ? H[ka](function() {
                                    (A = Xa.apply(this, arguments)) && m.isFunction(A.promise) ? A.promise().then(sa.resolve, sa.reject, sa.notify) : sa[w + "With"](this === H ? sa : this, [A])
                                }) : H[ka](sa[w])
                            })
                        }).promise()
                    },
                    promise: function(V) {
                        if (V == null) V = D;
                        else for (var qa in D) V[qa] = D[qa];
                        return V
                    }
                },
                H = D.promise({}),
        ...
        when: function(h) {
            ...
            function n(qa) {
                return function(ca) {
                    D[qa] = arguments.length > 1 ? la.call(arguments, 0) : ca;
                    R.notifyWith(V, D)
                }
            }
            var p = la.call(arguments, 0),
                u = 0,
                z = p.length,
                D = Array(z),
                H = z,
                R = z <= 1 && h && m.isFunction(h.promise) ? h : m.Deferred(),
                V = R.promise();
            if (z > 1) {
                for (; u < z; u++) if (p[u] && p[u].promise && m.isFunction(p[u].promise)) p[u].promise().then(l(u), R.reject, n(u));
                else --H;
                H || R.resolveWith(R, p)
    ...
    m.support = function() {
        ...
        D = {
            ...
            unknownElems: !! h.getElementsByTagName("nav").length,
            checkOn: n.value === "on",
        ...
        h.innerHTML = "<table><tr><td style='padding:0;border:0;display:none'></td><td>t</td></tr></table>";
        ...
        if (W.defaultView && W.defaultView.getComputedStyle) {
            ...
            h.appendChild(n);
            D.reliableMarginRight = (parseInt((W.defaultView.getComputedStyle(n, null) || {
                marginRight: 0
            }).marginRight, 10) || 0) === 0
        }
        if (h.attachEvent) for (V in {
            submit: 1,
            change: 1,
            focusin: 1
        }) {
        ...
        m(function() {
            ...
            if (H = W.getElementsByTagName("body")[0]) {
                ...
                ka = sa.firstChild;
                Ia = {
                    doesNotAddBorder: ka.offsetTop !== 5,
                    doesAddBorderForTableAndCells: sa.nextSibling.firstChild.firstChild.offsetTop === 5
                };
    ...
    m.extend({
        ...
        data: function(h, l, n, p) {
            if (m.acceptData(h)) {
                var u, z = typeof l === "string",
                    D = (u = h.nodeType) ? m.cache : h,
                    H = u ? h[m.expando] : h[m.expando] && m.expando,
                    R = l === "events";
                if (!((!H || !D[H] || !R && !p && !D[H].data) && z && n === d)) {
                    if (!H) if (u) h[m.expando] = H = ++m.uuid;
                    else H = m.expando;
                    if (!D[H]) {
                        D[H] = {};
                        if (!u) D[H].toJSON = m.noop
                    }
                    if (typeof l === "object" || typeof l === "function") if (p) D[H] = m.extend(D[H], l);
                    else D[H].data = m.extend(D[H].data, l);
                    u = h = D[H];
                    if (!p) {
                        if (!h.data) h.data = {};
                        h = h.data
        ...
        removeData: function(h, l, n) {
            if (m.acceptData(h)) {
                var p, u, z, D = h.nodeType,
                    H = D ? m.cache : h,
                    R = D ? h[m.expando] : m.expando;
                if (H[R]) {
                    if (l) if (p = n ? H[R] : H[R].data) {
                        if (!m.isArray(l)) if (l in p) l = [l];
                        else {
                            l = m.camelCase(l);
                            l = l in p ? [l] : l.split(" ")
                        }
                    ...
                    if (m.support.deleteExpando || !H.setInterval) delete H[R];
                    else H[R] = null;
                    if (D) if (m.support.deleteExpando) delete h[m.expando];
                    else if (h.removeAttribute) h.removeAttribute(m.expando);
    ...
    m.extend({
        ...
        _unmark: function(h, l, n) {
            ...
            if (l) {
                n = n || "fx";
                var p = n + "mark";
                if (h = h ? 0 : (m._data(l, p) || 1) - 1) m._data(l, p, h);
                else {
        ...
        queue: function(h, l, n) {
            ...
            if (h) {
                l = (l || "fx") + "queue";
                p = m._data(h, l);
                if (n) if (!p || m.isArray(n)) p = m._data(h, l, m.makeArray(n));
                else p.push(n);
                return p || []
            }
        },
    ...
    var za = /[\n\t\r]/g,
        ...
        S = /\r/g,
        ua = /^(?:button|input)$/i,
        pa = /^(?:button|input|object|select|textarea)$/i,
        Q = /^a(?:rea)?$/i,
    ...
    m.fn.extend({
        ...
        addClass: function(h) {
            ...
            if (h && typeof h === "string") {
                ...
                for (p = this.length; n < p; n++) {
                    u = this[n];
                    if (u.nodeType === 1) if (!u.className && l.length === 1) u.className = h;
                    else {
                        z = " " + u.className + " ";
                        D = 0;
        ...
        toggleClass: function(h, l) {
            ...
            if (m.isFunction(h)) return this.each(function(u) {
                m(this).toggleClass(h.call(this, u, this.className, l), l)
            });
            return this.each(function() {
        ...
        hasClass: function(h) {
            h = " " + h + " ";
            for (var l = 0, n = this.length; l < n; l++) if (this[l].nodeType === 1 && (" " + this[l].className + " ").replace(za, " ").indexOf(h) > -1) return true;
            return false
        },
        val: function(h) {
            var l, n, p, u = this[0];
            ...
            return this.each(function(z) {
                ...
                if (this.nodeType === 1) {
                    ...
                    else if (m.isArray(z)) z = m.map(z, function(H) {
                        return H == null ? "" : H + ""
                    });
    ...
    m.extend({
            ...
            select: {
                get: function(h) {
                    ...
                    for (n = D ? p + 1 : z.length; h < n; h++) {
                        l = z[h];
                        if (l.selected && (m.support.optDisabled ? !l.disabled : l.getAttribute("disabled") === null) && (!l.parentNode.disabled || !m.nodeName(l.parentNode, "optgroup"))) {
                            l = m(l).val();
                            if (D) return l;
                            u.push(l)
                        }
        ...
        attr: function(h, l, n, p) {
            ...
            if (n !== d) if (n === null) {
                m.removeAttr(h, l);
                return d
            } else if (z && "set" in z && p && (u = z.set(h, n, l)) !== d) return u;
            else {
                h.setAttribute(l, "" + n);
                return n
            } else if (z && "get" in z && p && (u = z.get(h, l)) !== null) return u;
            else {
                u = h.getAttribute(l);
                return u === null ? d : u
            }
        ...
        attrHooks: {
            type: {
                set: function(h, l) {
                    if (ua.test(h.nodeName) && h.parentNode) m.error("type property can't be changed");
                    else if (!m.support.radioValue && l === "radio" && m.nodeName(h, "input")) {
                        var n = h.value;
        ...
        prop: function(h, l, n) {
            ...
            return n !== d ? u && "set" in u && (p = u.set(h, n, l)) !== d ? p : h[l] = n : u && "get" in u && (p = u.get(h, l)) !== null ? p : h[l]
        },
        propHooks: {
            tabIndex: {
                get: function(h) {
    ...
    if (!ma) {
        ...
        m.each(["width", "height"], function(h, l) {
            m.attrHooks[l] = m.extend(m.attrHooks[l], {
                set: function(n, p) {
                    if (p === "") {
    ...
    if (!m.support.style) m.attrHooks.style = {
        get: function(h) {
    ...
    if (!m.support.optSelected) m.propHooks.selected = m.extend(m.propHooks.selected, {
        get: function() {
            return null
        }
    });
    ...
    var Ha = /^(?:textarea|input|select)$/i,
        Pa = /^([^\.]*)?(?:\.(.+))?$/,
        Qa = /\bhover(\.\S+)?/,
        sb = /^key/,
    ...
    m.event = {
            ...
            if (!(h.nodeType === 3 || h.nodeType === 8 || !l || !n || !(z = m._data(h)))) {
                ...
                if (!D) {
                    z.handle = D = function(Ia) {
                        return typeof m !== "undefined" && (!Ia || m.event.triggered !== Ia.type) ? m.event.dispatch.apply(D.elem, arguments) : d
                    };
                    D.elem = h
                }
                l = jb(l).split(" ");
                for (z = 0; z < l.length; z++) {
                    ...
                    if (!sa) {
                        sa = H[V] = [];
                        sa.delegateCount = 0;
                        if (!ka.setup || ka.setup.call(h, p, qa, D) === false) if (h.addEventListener) h.addEventListener(V, D, false);
                        else h.attachEvent && h.attachEvent("on" + V, D)
                    }
                    if (ka.add) {
                        ka.add.call(h, R);
        ...
        remove: function(h, l, n, p) {
            var u = m.hasData(h) && m._data(h),
                z, D, H, R, V, qa, ca, sa, ka;
            if (u && (qa = u.events)) {
                l = jb(l || "").split(" ");
                for (z = 0; z < l.length; z++) {
                    D = Pa.exec(l[z]) || [];
                    ...
                    if (!H) {
                        D = D ? "." + D : "";
                        for (V in qa) m.event.remove(h, V + D, n, p);
                        return
                    }
                    ...
                    if (sa.length === 0 && R !== sa.length) {
                        if (!ca.teardown || ca.teardown.call(h, D) === false) m.removeEvent(h, H, u.handle);
                        delete qa[H]
                    }
                }
        ...
        trigger: function(h, l, n, p) {
            if (!(n && (n.nodeType === 3 || n.nodeType === 8))) {
                ...
                if (!((!n || m.event.customEvent[u]) && !m.event.global[u])) {
                    h = typeof h === "object" ? h[m.expando] ? h : new m.Event(u, h) : new m.Event(u);
                    h.type = u;
                    h.isTrigger = true;
                    h.exclusive = D;
                    h.namespace = z.join(".");
        ...
        dispatch: function(h) {
            ...
            var l = (m._data(this, "events") || {})[h.type] || [],
                n = l.delegateCount,
                p = [].slice.call(arguments, 0),
                u = !h.exclusive && !h.namespace,
                z = (m.event.special[h.type] || {}).handle,
                D = [],
                H, R, V, qa, ca, sa, ka;
            p[0] = h;
            h.delegateTarget = this;
            if (n && !h.target.disabled && !(h.button && h.type === "click")) for (R = h.target; R != this; R = R.parentNode || this) {
                qa = {};
                ca = [];
                for (H = 0; H < n; H++) {
                    V = l[H];
                    sa = V.selector;
                    ka = qa[sa];
                    if (V.isPositional) ka = (ka || (qa[sa] = m(sa))).index(R) >= 0;
                    else if (ka === d) ka = qa[sa] = V.quick ? (!V.quick[1] || R.nodeName.toLowerCase() === V.quick[1]) && (!V.quick[2] || R.id === V.quick[2]) && (!V.quick[3] || V.quick[3].test(R.className)) : m(R).is(sa);
                    ka && ca.push(V)
                }
                ca.length && D.push({
                    elem: R,
        ...
        mouseHooks: {
            ...
            filter: function(h, l) {
                ...
                if (h.pageX == null && l.clientX != null) {
                    ...
                    p = n.documentElement;
                    n = n.body;
                    h.pageX = l.clientX + (p && p.scrollLeft || n && n.scrollLeft || 0) - (p && p.clientLeft || n && n.clientLeft || 0);
        ...
        fix: function(h) {
            ...
            var l, n, p = h,
                u = m.event.fixHooks[h.type] || {},
                z = u.props ? this.props.concat(u.props) : this.props;
            h = m.Event(p);
            for (l = z.length; l;) {
                n = z[--l];
                h[n] = p[n]
        ...
        simulate: function(h, l, n, p) {
            h = m.extend(new m.Event, n, {
                type: h,
                isSimulated: true,
                originalEvent: {}
            });
            p ? m.event.trigger(h, null, l) : m.event.dispatch.call(l, h);
    ...
    m.each({
        ...
        m.event.special[h] = m.event.special[l] = {
            delegateType: l,
            bindType: l,
            handle: function(n) {
    ...
    if (!m.support.submitBubbles) m.event.special.submit = {
        setup: function() {
            if (m.nodeName(this, "form")) return false;
            m.event.add(this, "click._submit keypress._submit", function(h) {
                h = h.target;
            ...
            m.event.add(this, "beforeactivate._change", function(h) {
                ...
                if (Ha.test(h.nodeName) && !h._change_attached) {
                    m.event.add(h, "change._change", function(l) {
                        this.parentNode && !l.isSimulated && m.event.simulate("change", this.parentNode, l, true)
                    });
    ...
    m.support.focusinBubbles || m.each({
        ...
        m.event.special[l] = {
            setup: function() {
                n++ === 0 && W.addEventListener(h, p, true)
            },
            teardown: function() {
    ...
    m.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "), function(h, l) {
        m.fn[l] = function(n, p) {
            if (p == null) {
                p = n;
                n = null
    ...
    (function() {
        ...
        var ca = function(x, F, M, O) {
                ...
                if (ia.length > 1 && Ia.exec(x)) if (ia.length === 2 && ka.relative[ia[0]]) na = ta(ia[0] + ia[1], F, O);
                else for (na = ka.relative[ia[0]] ? [F] : ca(ia.shift(), F); ia.length;) {
                    x = ia.shift();
                    ...
                    if (F) {
                        T = O ? {
                            expr: ia.pop(),
                            set: A(O)
                        } : ca.find(ia.pop(), ia.length === 1 && (ia[0] === "~" || ia[0] === "+") && F.parentNode ? F.parentNode : F, ha);
                        na = T.expr ? ca.filter(T.expr, T.set) : T.set;
                        if (ia.length > 0) ga = A(na);
                        else I = false;
                        for (; ia.length;) {
                            T = Ba = ia.pop();
                            if (ka.relative[Ba]) T = ia.pop();
                            else Ba = "";
                            if (T == null) T = F;
                ...
                } else for (x = 0; ga[x] != null; x++) ga[x] && ga[x].nodeType === 1 && M.push(na[x]);
                else M.push.apply(M, ga);
                else A(ga, M);
                if (xa) {
                    ca(xa, U, M, O);
                    ca.uniqueSort(M)
        ...
        ca.uniqueSort = function(x) {
            if (ea) {
                D = H;
                x.sort(ea);
                if (D) for (var F = 1; F < x.length; F++) x[F] === x[F - 1] && x.splice(F--, 1)
            }
            return x
        };
        ...
        ca.find = function(x, F, M) {
            ...
            O || (O = typeof F.getElementsByTagName !== "undefined" ? F.getElementsByTagName("*") : []);
            return {
                set: O,
                expr: x
            }
            ...
            for (var U, T, na, ga, xa, Ba, I, ha, ia = x, oa = [], Ca = F, Ga = F && F[0] && ca.isXML(F[0]); x && F.length;) {
                for (na in ka.filter) if ((U = ka.leftMatch[na].exec(x)) != null && U[2]) {
                    ...
                    if (xa.substr(xa.length - 1) !== "\\") {
                        ...
                        if (U) for (I = 0;
                        (xa = Ca[I]) != null; I++) if (xa) {
                            ga = Ba(xa, U, I, Ca);
                            ha = O ^ ga;
                            if (M && ga != null) if (ha) T = true;
                            else Ca[I] = false;
                            else if (ha) {
                                oa.push(xa);
                                T = true
        ...
        var sa = ca.getText = function(x) {
                ...
                F = x.nodeType;
                var O = "";
                if (F) if (F === 1) if (typeof x.textContent === "string") return x.textContent;
                else if (typeof x.innerText === "string") return x.innerText.replace(V, "");
                else for (x = x.firstChild; x; x = x.nextSibling) O += sa(x);
                else {
            ...
            ka = ca.selectors = {
                ...
                preFilter: {
                    CLASS: function(x, F, M, O, U, T) {
                        x = " " + x[1].replace(R, "") + " ";
                        if (T) return x;
                        T = 0;
                        for (var na;
                        (na = F[T]) != null; T++) if (na) if (U ^ (na.className && (" " + na.className + " ").replace(/[\t\n\r]/g, " ").indexOf(x) >= 0)) M || O.push(na);
                        else if (M) F[T] = false;
                        return false
                    },
                    ID: function(x) {
                    ...
                    CHILD: function(x) {
                        if (x[1] === "nth") {
                            x[2] || ca.error(x[0]);
                            x[2] = x[2].replace(/^\+|\s*/g, "");
                            var F = /(-?)(\d*)(?:n([+\-]?\d*))?/.exec(x[2] === "even" && "2n" || x[2] === "odd" && "2n+1" || !/\D/.test(x[2]) && "0n+" + x[2] || x[2]);
                            x[2] = F[1] + (F[2] || 1) - 0;
                            x[3] = F[3] - 0
                    ...
                    PSEUDO: function(x, F, M, O, U) {
                        if (x[1] === "not") if ((n.exec(x[3]) || "").length > 1 || /^\w/.test(x[3])) x[3] = ca(x[3], null, null, F);
                        else {
                            x = ca.filter(x[3], F, M, true ^ U);
                            M || O.push.apply(O, x);
                            return false
                        } else if (ka.match.POS.test(x[0]) || ka.match.CHILD.test(x[0])) return true;
                        return x
                    },
                    POS: function(x) {
                        x.unshift(true);
                ...
                filters: {
                    ...
                    submit: function(x) {
                        ...
                        return (F === "input" || F === "button") && "submit" === x.type
                    },
                    image: function(x) {
                ...
                filter: {
                    PSEUDO: function(x, F, M, O) {
                        var U = F[1],
                            T = ka.filters[U];
                        if (T) return T(x, M, F, O);
                        else if (U === "contains") return (x.textContent || x.innerText || sa([x]) || "").indexOf(F[3]) >= 0;
                        else if (U === "not") {
                            F = F[3];
                            M = 0;
                    ...
                    ATTR: function(x, F) {
                        ...
                        var O = M + "",
                            U = F[2],
                            T = F[4];
                        return M == null ? U === "!=" : !U && ca.attr ? M != null : U === "=" ? O === T : U === "*=" ? O.indexOf(T) >= 0 : U === "~=" ? (" " + O + " ").indexOf(T) >= 0 : !T ? O && M !== false : U === "!=" ? O !== T : U === "^=" ? O.indexOf(T) === 0 : U === "$=" ? O.substr(O.length - T.length) === T : U === "|=" ? O === T || O.substr(0, T.length + 1) === T + "-" : false
                    },
        ...
        try {
            ...
            A = function(x, F) {
                var M = 0,
                    O = F || [];
                if (z.call(x) === "[object Array]") Array.prototype.push.apply(O, x);
                else if (typeof x.length === "number") for (var U = x.length; M < U; M++) O.push(x[M]);
                else for (; x[M]; M++) O.push(x[M]);
                return O
            }
        }
        var ea, aa;
        if (W.documentElement.compareDocumentPosition) ea = function(x, F) {
            ...
            if (!x.compareDocumentPosition || !F.compareDocumentPosition) return x.compareDocumentPosition ? -1 : 1;
            ...
            ea = function(x, F) {
                ...
                return na === M ? aa(x, T[na], -1) : aa(U[na], F, 1)
            };
            aa = function(x, F, M) {
                if (x === F) return M;
        ...
        (function() {
            ...
            if (x.firstChild && typeof x.firstChild.getAttribute !== "undefined" && x.firstChild.getAttribute("href") !== "#") ka.attrHandle.href = function(F) {
        ...
        function() {
            ...
            if (!(F.querySelectorAll && F.querySelectorAll(".TEST").length === 0)) {
                ca = function(O, U, T, na) {
                    ...
                    if (!na && !ca.isXML(U)) {
                        var ga = /^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(O);
                        if (ga && (U.nodeType === 1 || U.nodeType === 9)) if (ga[1]) return A(U.getElementsByTagName(O), T);
                        else if (ga[2] && ka.find.CLASS && U.getElementsByClassName) return A(U.getElementsByClassName(ga[2]), T);
                        if (U.nodeType === 9) {
                            if (O === "body" && U.body) return A([U.body], T);
                            else if (ga && ga[3]) {
                            ...
                            ga = U;
                            var I = (xa = U.getAttribute("id")) || "__sizzle__",
                                ha = U.parentNode,
                                ia = /^\s*[+~]/.test(O);
                            if (xa) I = I.replace(/'/g, "\\$&");
                            else U.setAttribute("id", I);
        ...
        (function() {
            var x = W.documentElement,
                F = x.matchesSelector || x.mozMatchesSelector || x.webkitMatchesSelector || x.msMatchesSelector;
            if (F) {
                var M = !F.call(W.createElement("div"), "div"),
                    O = false;
                try {
        ...
        ca.contains = W.documentElement.contains ?
        function(x, F) {
        ...
        var ta = function(x, F, M) {
                var O, U = [],
                    T = "";
                for (F = F.nodeType ? [F] : F; O = ka.match.PSEUDO.exec(x);) {
                    T += O[0];
    ...
    m.fn.extend({
        ...
        closest: function(h, l) {
            ...
            if (m.isArray(h)) {
                for (u = 1; z && z.ownerDocument && z !== l;) {
                    for (p = 0; p < h.length; p++) m(z).is(h[p]) && n.push({
                        selector: h[p],
                        elem: z,
                        level: u
                    });
            ...
            var D = Lb.test(h) || typeof h !== "string" ? m(h, l || this.context) : 0;
            p = 0;
        ...
        add: function(h, l) {
            var n = typeof h === "string" ? m(h, l) : m.makeArray(h && h.nodeType ? [h] : h),
                p = m.merge(this.get(), n);
    ...
    var eb = "abbr article aside audio canvas datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video",
        Mb = / jQuery\d+="(?:\d+|null)"/g,
        Nb = /^\s+/,
        Xb = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,
        Db = /<([\w:]+)/,
        Yb = /<tbody/i,
        fc = /<|&#?\w+;/,
        Ob = /<(?:script|style)/i,
        xb = /<(?:script|object|embed|option|style)/i,
        gc = RegExp("<(?:" + eb.replace(" ", "|") + ")", "i"),
    ...
    m.fn.extend({
        ...
        remove: function(h, l) {
            for (var n = 0, p;
            (p = this[n]) != null; n++) if (!h || m.filter(h, [p]).length) {
                if (!l && p.nodeType === 1) {
        ...
        empty: function() {
            for (var h = 0, l;
            (l = this[h]) != null; h++) for (l.nodeType === 1 && m.cleanData(l.getElementsByTagName("*")); l.firstChild;) l.removeChild(l.firstChild);
            return this
        },
        clone: function(h, l) {
            h = h == null ? false : h;
        ...
        html: function(h) {
            if (h === d) return this[0] && this[0].nodeType === 1 ? this[0].innerHTML.replace(Mb, "") : null;
            else if (typeof h === "string" && !Ob.test(h) && (m.support.leadingWhitespace || !Nb.test(h)) && !bb[(Db.exec(h) || ["", ""])[1].toLowerCase()]) {
                h = h.replace(Xb, "<$1></$2>");
                try {
        ...
        domManip: function(h, l, n) {
            ...
            if (this[0]) {
                p = D && D.parentNode;
                p = m.support.parentNode && p && p.nodeType === 11 && p.childNodes.length === this.length ? {
                    fragment: p
                } : m.buildFragment(h, this, H);
                z = p.fragment;
                if (u = z.childNodes.length === 1 ? z = z.firstChild : z.firstChild) {
                    l = l && m.nodeName(u, "tr");
                    u = 0;
                    for (var R = this.length, V = R - 1; u < R; u++) n.call(l ? m.nodeName(this[u], "table") ? this[u].getElementsByTagName("tbody")[0] || this[u].appendChild(this[u].ownerDocument.createElement("tbody")) : this[u] : this[u], p.cacheable || R > 1 && u < V ? m.clone(z, true, true) : z)
                }
                H.length && m.each(H, y)
            }
            return this
    ...
    m.extend({
            ...
            (H = h[D]) != null; D++) {
                ...
                if (H) {
                    if (typeof H === "string") if (fc.test(H)) {
                        ...
                        }!m.support.leadingWhitespace && Nb.test(H) && qa.insertBefore(l.createTextNode(Nb.exec(H)[0]), qa.firstChild);
                        H = qa.childNodes
                    } else H = l.createTextNode(H);
                    var ca;
                    if (!m.support.appendChecked) if (H[0] && typeof(ca = H.length) === "number") for (z = 0; z < ca; z++) t(H[z]);
                    else t(H);
                    if (H.nodeType) u.push(H);
                    else u = m.merge(u, H)
                }
            }
            if (n) {
                ...
                for (D = 0; u[D]; D++) if (p && m.nodeName(u[D], "script") && (!u[D].type || u[D].type.toLowerCase() === "text/javascript")) p.push(u[D].parentNode ? u[D].parentNode.removeChild(u[D]) : u[D]);
                else {
                    if (u[D].nodeType === 1) {
        ...
        cleanData: function(h) {
            for (var l, n, p = m.cache, u = m.event.special, z = m.support.deleteExpando, D = 0, H;
            (H = h[D]) != null; D++) if (!(H.nodeName && m.noData[H.nodeName.toLowerCase()])) if (n = H[m.expando]) {
                if ((l = p[n]) && l.events) {
                    for (var R in l.events) u[R] ? m.event.remove(H, R) : m.removeEvent(H, R, l.handle);
                    if (l.handle) l.handle.elem = null
                }
                if (z) delete H[m.expando];
                else H.removeAttribute && H.removeAttribute(m.expando);
                delete p[n]
            }
        }
    });
    ...
    m.extend({
        ...
        style: function(h, l, n, p) {
            if (!(!h || h.nodeType === 3 || h.nodeType === 8 || !h.style)) {
                var u, z = m.camelCase(l),
                    D = h.style,
                    H = m.cssHooks[z];
                l = m.cssProps[z] || z;
                if (n !== d) {
                    ...
                    if (!(n == null || p === "number" && isNaN(n))) {
                        if (p === "number" && !m.cssNumber[z]) n += "px";
        ...
        css: function(h, l, n) {
            ...
            if (u && "get" in u && (p = u.get(h, true, n)) !== d) return p;
            else if (ab) return ab(h, l)
        },
        swap: function(h, l, n) {
            var p = {};
            for (var u in l) {
    ...
    m.each(["height", "width"], function(h, l) {
        m.cssHooks[l] = {
            get: function(n, p, u) {
                var z;
                if (p) {
                    if (n.offsetWidth !== 0) return E(n, l, u);
                    else m.swap(n, Ra, function() {
                        z = E(n, l, u)
                    });
                    return z
                }
    ...
    if (!m.support.opacity) m.cssHooks.opacity = {
        get: function(h, l) {
        ...
        set: function(h, l) {
            var n = h.style,
                p = h.currentStyle,
                u = m.isNumeric(l) ? "alpha(opacity=" + l * 100 + ")" : "",
                z = p && p.filter || n.filter || "";
            n.zoom = 1;
    ...
    m(function() {
        if (!m.support.reliableMarginRight) m.cssHooks.marginRight = {
            get: function(h, l) {
                var n;
                m.swap(h, {
    ...
    if (W.documentElement.currentStyle) tb = function(h, l) {
        var n, p, u = h.currentStyle && h.currentStyle[l],
            z = h.style;
    ...
    m.fn.extend({
        load: function(h, l, n) {
            if (typeof h !== "string" && La) return La.apply(this, arguments);
    ...
    m.extend({
        ...
        ajaxSettings: {
            url: mb,
            isLocal: /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(nb[1]),
            global: true,
            type: "GET",
        ...
        ajax: function(h, l) {
            ...
            var p = m.ajaxSetup({}, l),
                u = p.context || p,
                z = u !== p && (u.nodeType || u instanceof m) ? m(u) : m.event,
                D = m.Deferred(),
            ...
            J && m.active++ === 0 && m.event.trigger("ajaxStart");
            if (!p.hasContent) {
                if (p.data) {
            ...
            if (p.ifModified) {
                ...
                m.etag[V] && aa.setRequestHeader("If-None-Match", m.etag[V])
            }
    ...
    m.ajaxPrefilter("json jsonp", function(h, l, n) {
        ...
        if (h.dataTypes[0] === "jsonp" || h.jsonp !== false && (Ib.test(h.url) || l && Ib.test(h.data))) {
            var p, u = h.jsonpCallback = m.isFunction(h.jsonpCallback) ? h.jsonpCallback() : h.jsonpCallback,
                z = a[u],
                D = h.url,
                H = h.data,
                R = "$1" + u + "$2";
            if (h.jsonp !== false) {
                ...
                if (h.url === D) {
                    ...
                    if (h.data === H) D += (/\?/.test(D) ? "&" : "?") + h.jsonp + "=" + u
                }
            }
            h.url = D;
            h.data = H;
    ...
    m.ajaxPrefilter("script", function(h) {
    ...
    (function(h) {
        m.extend(m.support, {
            ajax: !! h,
            cors: !! h && "withCredentials" in h
        })
    })(m.ajaxSettings.xhr());
    m.support.ajax && m.ajaxTransport(function(h) {
        if (!h.crossDomain || m.support.cors) {
            var l;
            return {
                send: function(n, p) {
                    var u = h.xhr(),
                    ...
                    l = function(R, V) {
                        var qa, ca, sa, ka, Ia;
                        try {
                            if (l && (V || u.readyState === 4)) {
                                l = d;
                                if (z) {
                                    u.onreadystatechange = m.noop;
                                    ob && delete Oa[z]
                                }
                                if (V) u.readyState !== 4 && u.abort();
                                else {
                                    qa = u.status;
                                    ...
                                    if (!qa && h.isLocal && !h.crossDomain) qa = ka.text ? 200 : 404;
                                    else if (qa === 1223) qa = 204
                                }
                            }
                        } catch (w) {
                            V || p(-1, w)
    ...
    m.fn.extend({
        show: function(h, l, n) {
            if (h || h === 0) return this.animate(Z("show", 3), h, l, n);
            else {
                n = 0;
                for (var p = this.length; n < p; n++) {
                    ...
                    if (h.style) {
                        ...
                        l === "" && m.css(h, "display") === "none" && m._data(h, "olddisplay", X(h.nodeName))
                    }
                }
                for (n = 0; n < p; n++) {
                    h = this[n];
        ...
        hide: function(h, l, n) {
            if (h || h === 0) return this.animate(Z("hide", 3), h, l, n);
            else {
                n = 0;
                for (var p = this.length; n < p; n++) {
                    h = this[n];
        ...
        toggle: function(h, l, n) {
            ...
            if (m.isFunction(h) && m.isFunction(l)) this._toggle.apply(this, arguments);
            ...
            function u() {
                ...
                for (ca in h) {
                    ...
                    if (H && (V === "height" || V === "width")) {
                        ...
                        if (m.css(this, "display") === "inline" && m.css(this, "float") === "none") if (!m.support.inlineBlockNeedsLayout || X(this.nodeName) === "inline") this.style.display = "inline-block";
        ...
        stop: function(h, l, n) {
            ...
            return this.each(function() {
                ...
                if (h == null) for (u in H) H[u].stop && u.indexOf(".run") === u.length - 4 && p(this, H, u);
                else if (H[u = h + ".run"] && H[u].stop) p(this, H, u);
    ...
    m.extend({
        speed: function(h, l, n) {
            var p = h && typeof h === "object" ? m.extend({}, h) : {
                complete: n || !n && l || m.isFunction(h) && h,
                duration: h,
                easing: n && l || l && !m.isFunction(l) && l
            };
            ...
            p.complete = function(u) {
                ...
                if (p.queue) m.dequeue(this, p.queue);
                else u !== false && m._unmark(this)
            };
            return p
        },
        easing: {
            linear: function(h, l, n, p) {
                return n + p * h
            },
    ...
    m.fx.prototype = {
        ...
        cur: function() {
            ...
            return isNaN(h = parseFloat(l)) ? !l || l === "auto" ? 0 : l : h
        },
        ...
        show: function() {
            var h = m._data(this.elem, "fxshow" + this.prop);
        ...
        step: function(h) {
            ...
            if (h || n >= z.duration + this.startTime) {
                ...
                if (z.duration == Infinity) this.now = n;
                else {
                    h = n - this.startTime;
    ...
    m.extend(m.fx, {
        ...
        step: {
            opacity: function(h) {
                m.style(h.elem, "opacity", h.now)
            },
            _default: function(h) {
                if (h.elem.style && h.elem.style[h.prop] != null) h.elem.style[h.prop] = h.now + h.unit;
    ...
    var Ya = /^t(?:able|d|h)$/i,
        Vb = /^(?:body|html)$/i;
    m.fn.offset = "getBoundingClientRect" in W.documentElement ?
    function(h) {
        var l = this[0],
            n;
        if (h) return this.each(function(D) {
            m.offset.setOffset(this, h, D)
        });
        ...
        u = da(u);
        return {
            top: n.top + (u.pageYOffset || m.support.boxModel && z.scrollTop || l.scrollTop) - (z.clientTop || l.clientTop || 0),
            left: n.left + (u.pageXOffset || m.support.boxModel && z.scrollLeft || l.scrollLeft) - (z.clientLeft || l.clientLeft || 0)
        }
    } : function(h) {
        var l = this[0];
        ...
        if (!l || !l.ownerDocument) return null;
        if (l === l.ownerDocument.body) return m.offset.bodyOffset(l);
        var n, p = l.offsetParent,
            u = l,
            z = l.ownerDocument,
            D = z.documentElement,
            H = z.body;
        n = (z = z.defaultView) ? z.getComputedStyle(l, null) : l.currentStyle;
        for (var R = l.offsetTop, V = l.offsetLeft;
        (l = l.parentNode) && l !== H && l !== D;) {
        ...
        if (m.support.fixedPosition && n.position === "fixed") {
    ...
    m.offset = {
        ...
        setOffset: function(h, l, n) {
            ...
            var u = m(h),
                ...
                R = {},
                V = {};
            if ((p === "absolute" || p === "fixed") && m.inArray("auto", [D, H]) > -1) {
                V = u.position();
                p = V.top;
                H = V.left
            } else {
    ...
    m.fn.extend({
        position: function() {
            ...
            var h = this[0],
                l = this.offsetParent(),
                n = this.offset(),
                p = Vb.test(l[0].nodeName) ? {
                    top: 0,
                    left: 0
                } : l.offset();
            n.top -= parseFloat(m.css(h, "marginTop")) || 0;
            n.left -= parseFloat(m.css(h, "marginLeft")) || 0;
    ...
    m.each(["Left", "Top"], function(h, l) {
        ...
        m.fn[n] = function(p) {
            ...
            if (p === d) {
                u = this[0];
                if (!u) return null;
                return (z = da(u)) ? "pageXOffset" in z ? z[h ? "pageYOffset" : "pageXOffset"] : m.support.boxModel && z.document.documentElement[n] || z.document.body[n] : u[n]
            }
            return this.each(function() {
                if (z = da(this)) z.scrollTo(!h ? p : m(z).scrollLeft(), h ? p : m(z).scrollTop());
                else this[n] = p
            })
        }
    });
    m.each(["Height", "Width"], function(h, l) {
        ...
        m.fn[n] = function(p) {
            ...
            if (m.isWindow(u)) {
                var z = u.document.documentElement["client" + l],
                    D = u.document.body;
                return u.document.compatMode === "CSS1Compat" && z || D && D["client" + l] || z
            } else if (u.nodeType === 9) return Math.max(u.documentElement["client" + l], u.body["scroll" + l], u.documentElement["scroll" + l], u.body["offset" + l], u.documentElement["offset" + l]);
            else if (p === d) {
                u = m.css(u, n);
                z = parseFloat(u);
                return m.isNumeric(z) ? z : u
...
(function(a) {
    var d = false,
        ...
        e = function(f, j, g) {
            var k;
            g = g || f;
            for (k in f) g[k] = typeof f[k] == "function" && typeof j[k] == "function" && (!b || c.test(f[k])) ?
            function(o, s) {
                return function() {
                    var q = this._super,
                        r;
    ...
    a.extend(a.Class, {
        callback: function(f) {
            var j = jQuery.makeArray(arguments),
                g;
            f = j.shift();
            jQuery.isArray(f) || (f = [f]);
            g = this;
            return function() {
        ...
        newInstance: function() {
            var f = this.rawInstance(),
                j;
            if (f.setup) j = f.setup.apply(f, arguments);
            if (f.init) f.init.apply(f, a.isArray(j) ? j : arguments);
            return f
        },
        setup: function(f) {
        ...
        extend: function(f, j, g) {
            ...
            d = false;
            e(g, o, t);
            for (q in this) if (this.hasOwnProperty(q) && a.inArray(q, ["prototype", "defaults", "getObject"]) == -1) k[q] = this[q];
            e(j, this, k);
            if (f) {
                v = f.split(s);
                r = v.pop();
...
(function(a) {
    ...
    a.cleanData = function(b) {
        for (var c = 0, e;
        (e = b[c]) != null; c++) a(e).triggerHandler("destroyed");
        d(b)
    }
})(jQuery);
(function(a) {
    ...
    a.Class.extend("jQuery.Controller", {
            ...
            if (!(!this.shortName || this.fullName == "jQuery.Controller")) {
                ...
                a.fn[y] || (a.fn[y] = function(G) {
                    var B = a.makeArray(arguments),
                        N = typeof G == "string" && a.isFunction(t.prototype[G]),
                        ba = B[0];
                    this.each(function() {
                        var L = a.data(this, "controllers");
                        if (L = L && L[y]) N ? L[ba].apply(L, B.slice(1)) : L.update.apply(L, B);
                        else t.newInstance.apply(t, [this].concat(B))
                    });
                    return this
                });
        ...
        _getAction: function(t, y) {
            ...
            return {
                processor: this.processors[E[2]] || q,
                parts: E
            }
        },
        processors: {},
        ...
        setup: function(t, y) {
            ...
            (a.data(t, "controllers") || a.data(t, "controllers", {}))[B._fullName] = this;
            this._bindings = [];
    ...
    var q = function(t, y, E, G, B) {
        ...
        r = a.Controller.processors,
        v = function(t, y, E, G) {
            return c(window, y.replace(/window/, ""), e(G))
        };
    a.each("change click contextmenu dblclick keydown keyup keypress mousedown mousemove mouseout mouseover mouseup reset windowresize resize windowscroll scroll select submit dblclick focusin focusout load unload ready hashchange mouseenter mouseleave".split(" "), function(t, y) {
        r[y] = q
    });
        ...
        this.each(function() {
            if (E = a.data(this, "controllers")) for (var G in E) {
                var B = E[G],
                    N;
                if (!(N = !t.length)) a: {
                    for (N = 0; N < t.length; N++) if (typeof t[N] == "string" ? B.Class._shortName == t[N] : B instanceof t[N]) {
                        N = true;
                        break a
                    }
                    N = false
...
(function(a) {
    ...
    a.Controller.prototype.calculateHelpers = function(d) {
        var b = {};
        if (d) if (a.isArray(d)) for (var c = 0; c < d.length; c++) a.extend(b, d[c]);
        else a.extend(b, d);
        else {
...
(function() {
    jQuery.fn.compare = function(a) {
        ...
        if (this[0].sourceIndex) {
            b += this[0].sourceIndex < a.sourceIndex && 4;
...
(function(a) {
    ...
    a.fn.withinBox = function(d, b, c, e, f) {
        ...
        this.each(function() {
            ...
            var k = f ? jQuery.data(this, "offset", g.offset()) : g.offset(),
                o = g.width();
            g = g.height();
...
(function(a) {
    ...
    a.View = function(f, j, g) {
        ...
        s = f.replace(/[\/\.]/g, "_");
        k = a.View.types[k];
        if (a.View.cached[s]) f = a.View.cached[s];
        else if (o = document.getElementById(s)) {
...
(function(a) {
    ...
    c.Scanner.to_text = function(e) {
        ...
        if (e.toString) return f ? e.toString(f) : e.toString();
        return ""
    };
    c.Scanner.prototype = {
        scan: function(e) {
    ...
    c.Compiler.prototype = {
        compile: function(e, f) {
            e = e || {};
            this.out = "";
            var j = new c.Buffer(this.pre_cmd, this.post_cmd),
                g = "",
                k = function(r) {
                    r = r.replace(/\\/g, "\\\\");
                    r = r.replace(/\n/g, "\\n");
    ...
    a.View.register({
        ...
        get: function(e, f) {
            var j = f.match(/\.[\w\d]+[\?]+/),
                g = "",
                k = "ejs.js ERROR: There is no template or an empty template at " + f;
            g = a.ajax({
                async: false,
                url: f + (j ? "&" : "?") + ("cver=" + gsConfig.coreVersion),
                dataType: "text",
                statusCode: {
                    404: function(o) {
                        console.warn(o);
            ...
            if (!g.match(/[^\s]/)) throw "ejs.js ERROR: There is no template or an empty template at " + f;
            return this.renderer(e, g)
        },
        script: function(e, f) {
            return ["jQuery.View.EJS(function(_CONTEXT,_VIEW) { try { with(_VIEW) { with (_CONTEXT) {", (new c({
                text: f
            })).out(), " return ___ViewO.join('');}}}catch(e){e.lineNumber=null;throw e;}})"].join("")
        },
...
(function(a) {
    ...
    jQuery.Class.extend("jQuery.Model", {
        ...
        wrapMany: function(b) {
            if (!b) return null;
            var c = new(this.List || Array),
                e = a.isArray(b),
                f = e ? b : b.data,
                j = f.length,
                g = 0;
            for (c._use_call = true; g < j; g++) c.push(this.wrap(f[g]));
        ...
        _setProperty: function(b, c) {
            var e = this.Class,
                f = e.attributes[b] || e.addAttr(b, e.guessType(c));
            f = e.converters[f];
        ...
        attrs: function(b) {
            ...
            if (b) {
                var e = this.Class.id;
                for (c in b) c != e && this.attr(c, b[c]);
...
(function(a) {
    this._ = {
        ...
        makeUrlForShare: function(d, b, c) {
            var e = encodeURIComponent("http://grooveshark.com" + c.toUrl().replace("#!", "")),
                f = "";
            switch (b) {
            case "song":
            ...
            switch (d) {
            case "reddit":
                return "http://www.reddit.com/submit?title=" + f + "&url=" + e;
            case "stumbleupon":
        ...
        cleanURLSlug: function(d) {
            d = d.replace(/^\s+|\s+$/g, "");
            d = d.toLowerCase();
            for (var b = 0; b < 28; b++) d = d.replace(RegExp("\u00e0\u00e1\u00e4\u00e2\u00e8\u00e9\u00eb\u00ea\u00ec\u00ed\u00ef\u00ee\u00f2\u00f3\u00f6\u00f4\u00f9\u00fa\u00fc\u00fb\u00f1\u00e7\u00b7/_,:;".charAt(b), "g"), "aaaaeeeeiiiioooouuuunc------".charAt(b));
            return d = d.replace(/[^a-z0-9 -]/g, "").replace(/\s+/g, "_").replace(/-+/g, "_").replace(/^_+|_+$/g, "")
        },
        cleanTextDiv: $(document.createElement("div")),
        ...
        forEach: function(d, b, c) {
            if (!_.isEmpty(d)) {
                if (Array.prototype.forEach && d.forEach === Array.prototype.forEach) d.forEach(b, c);
                else if (_.isNumber(d.length)) for (var e = 0, f = d.length; e < f; e++) b.call(c, d[e], e, d);
                else for (e in d) Object.prototype.hasOwnProperty.call(d, e) && b.call(c, d[e], e, d);
                return d
            }
        },
        map: function(d, b, c) {
        ...
        isEmpty: function(d) {
            ...
            for (var b in d) if (Object.prototype.hasOwnProperty.call(d, b)) return false;
            return true
        },
        count: function(d) {
            var b = 0;
        ...
        globalDragProxyMousewheel: function(d, b) {
            ...
            if (c.within(d.clientX, d.clientY).length > 0) c.scrollTop(c.scrollTop() - 82 * b);
            else {
                c = $("#queue_list_window");
                if (c.within(d.clientX, d.clientY).length > 0) c.scrollLeft(c.scrollLeft() - 82 * b);
                else {
        ...
        browserDetect: function() {
            ...
            if ($.browser.adobeair) {
                b = b.substring(b.indexOf("adobeair/") + 9);
                b = b.substring(0, b.indexOf("."));
                d.browser = "adobeair";
                d.version = parseFloat(b);
                $.browser.safari = false
        ...
        getSort: function(d, b) {
            b = b ? 1 : -1;
            return function(c, e) {
                var f = _.isString(c[d]) ? c[d].toLowerCase() : c[d],
                    j = _.isString(e[d]) ? e[d].toLowerCase() : e[d];
                if (f > j) return b;
                if (f < j) return -1 * b;
                return 0
            }
        ...
        checkEmailMisspells: function(d, b) {
            ...
            var e = function(f, j) {
                    for (var g, k = 99, o = null, s = 0; s < j.length; s++) {
                        ...
                        else if (g == null || g.length === 0) g = f.length;
                        else {
                            for (var q = 0, r = 0, v = 0, t = 0; q + r < f.length && q + v < g.length;) {
                                if (f[q + r] == g[q + v]) t++;
                                else for (var y = v = r = 0; y < 5; y++) {
                ...
                }(c[1], ["yahoo.com", "google.com", "hotmail.com", "gmail.com", "me.com", "aol.com", "mac.com", "live.com", "comcast.net", "googlemail.com", "msn.com", "hotmail.co.uk", "yahoo.co.uk", "facebook.com", "verizon.net", "sbcglobal.net", "att.net", "gmx.com", "mail.com"]);
            return e ? b({
                address: c[0],
                domain: e,
                full: c[0] + "@" + e
    ...
    if (!Array.prototype.filter) Array.prototype.filter = function(d, b) {
...
(function() {
    ...
    if (typeof JSON.stringify !== "function") JSON.stringify = function(o, s, q) {
        var r;
        j = f = "";
        if (typeof q === "number") for (r = 0; r < q; r += 1) j += " ";
...
var swfobject = function() {
        ...
        function b(Q) {
            if (typeof ja.addEventListener != B) ja.addEventListener("load", Q, false);
            else if (typeof K.addEventListener != B) K.addEventListener("load", Q, false);
            else if (typeof ja.attachEvent != B) v(ja, "onload", Q);
            else if (typeof ja.onload == "function") {
                var fa = ja.onload;
                ja.onload = function() {
                    fa();
                    Q()
        ...
        function c() {
            var Q = K.getElementsByTagName("body")[0],
                fa = K.createElement(N);
            ...
            if (Q > 0) for (var fa = 0; fa < Q; fa++) {
                ...
                if (pa.pv[0] > 0) {
                    ...
                    if (Fa) if (t(W[fa].swfVersion) && !(pa.wk && pa.wk < 312)) {
                        ...
                        if (Fa.getAttribute("align")) ya.align = Fa.getAttribute("align");
                        var Ha = {};
        ...
        function f(Q) {
            var fa = null;
            if ((Q = r(Q)) && Q.nodeName == "OBJECT") if (typeof Q.SetVariable != B) fa = Q;
            else if (Q = Q.getElementsByTagName(N)[0]) fa = Q;
            return fa
        }
        ...
        function g(Q, fa, ma, va) {
            ...
            if (ya) {
                ...
                va = "MMredirectURL=" + ja.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + va + "&MMdoctitle=" + K.title;
                if (typeof fa.flashvars != B) fa.flashvars += "&" + va;
                else fa.flashvars = va;
        ...
        function o(Q) {
            var fa = K.createElement("div");
            if (pa.win && pa.ie) fa.innerHTML = Q.innerHTML;
            else if (Q = Q.getElementsByTagName(N)[0]) if (Q = Q.childNodes) for (var ma = Q.length, va = 0; va < ma; va++)!(Q[va].nodeType == 1 && Q[va].nodeName == "PARAM") && Q[va].nodeType != 8 && fa.appendChild(Q[va].cloneNode(true));
            return fa
        }
        function s(Q, fa, ma) {
            var va, ya = r(ma);
            ...
            if (ya) {
                ...
                if (pa.ie && pa.win) {
                    var Fa = "";
                    for (var Ha in Q) if (Q[Ha] != Object.prototype[Ha]) if (Ha.toLowerCase() == "data") fa.movie = Q[Ha];
                    else if (Ha.toLowerCase() == "styleclass") Fa += ' class="' + Q[Ha] + '"';
                    else if (Ha.toLowerCase() != "classid") Fa += " " + Ha + '="' + Q[Ha] + '"';
                    Ha = "";
                    for (var Pa in fa) if (fa[Pa] != Object.prototype[Pa]) Ha += '<param name="' + Pa + '" value="' + fa[Pa] + '" />';
                    ya.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + Fa + ">" + Ha + "</object>";
                    ra[ra.length] = Q.id;
                    va = r(Q.id)
                } else {
                    Pa = K.createElement(N);
                    Pa.setAttribute("type", ba);
                    for (var Qa in Q) if (Q[Qa] != Object.prototype[Qa]) if (Qa.toLowerCase() == "styleclass") Pa.setAttribute("class", Q[Qa]);
                    else Qa.toLowerCase() != "classid" && Pa.setAttribute(Qa, Q[Qa]);
                    ...
                    ya.parentNode.replaceChild(Pa, ya);
                    va = Pa
                }
            }
            return va
            ...
            if (!(pa.ie && pa.mac)) {
                ...
                if (ya) {
                    ...
                    if (!C || S != ma) {
                        ...
                        C = ya.appendChild(va);
                        if (pa.ie && pa.win && typeof K.styleSheets != B && K.styleSheets.length > 0) C = K.styleSheets[K.styleSheets.length - 1];
                        S = ma
                    }
                    if (pa.ie && pa.win) C && typeof C.addRule == N && C.addRule(Q, fa);
                    else C && typeof K.createTextNode != B && C.appendChild(K.createTextNode(Q + " {" + fa + "}"))
                }
            }
        }
        function E(Q, fa) {
            if (ua) {
                ...
                if (Aa && r(Q)) r(Q).style.visibility = ma;
                else y("#" + Q, "visibility:" + ma)
            }
        }
        function G(Q) {
        ...
        var B = "undefined",
            ...
            C, S, ua = true,
            pa = function() {
                var Q = typeof K.getElementById != B && typeof K.getElementsByTagName != B && typeof K.createElement != B,
                    fa = Z.userAgent.toLowerCase(),
                    ma = Z.platform.toLowerCase(),
                    va = ma ? /win/.test(ma) : /win/.test(fa);
                ma = ma ? /mac/.test(ma) : /mac/.test(fa);
                fa = /webkit/.test(fa) ? parseFloat(fa.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : false;
                var ya = !+"\u000b1",
                    Fa = [0, 0, 0],
                    Ha = null;
                if (typeof Z.plugins != B && typeof Z.plugins["Shockwave Flash"] == N) {
        ...
        return {
            registerObject: function(Q, fa, ma, va) {
                if (pa.w3 && Q && fa) {
                    var ya = {};
                    ya.id = Q;
                    ya.swfVersion = fa;
            ...
            embedSWF: function(Q, fa, ma, va, ya, Fa, Ha, Pa, Qa, sb) {
                ...
                if (pa.w3 && !(pa.wk && pa.wk < 312) && Q && fa && ma && va && ya) {
                    ...
                    d(function() {
                        ...
                        if (Ha && typeof Ha === N) for (var kb in Ha) if (typeof db.flashvars != B) db.flashvars += "&" + kb + "=" + Ha[kb];
                        else db.flashvars = kb + "=" + Ha[kb];
                        if (t(ya)) {
                            jb = s(fb, db, fa);
                            fb.id == fa && E(fa, true);
                            wb.success = true;
            ...
            addDomLoadEvent: d,
            addLoadEvent: b,
            getQueryParamValue: function(Q) {
                var fa = K.location.search || K.location.hash;
                if (fa) {
                    if (/\?/.test(fa)) fa = fa.split("?")[1];
                    if (Q == null) return G(fa);
                    fa = fa.split("&");
                    for (var ma = 0; ma < fa.length; ma++) if (fa[ma].substring(0, fa[ma].indexOf("=")) == Q) return G(fa[ma].substring(fa[ma].indexOf("=") + 1))
                }
                return ""
            },
    ...
    j = function() {
        function s() {
            ...
            if (G !== v) {
                y(v = G, B);
                a(d).trigger(e)
            } else if (B !== v) location.href = location.href.replace(/#.*/, "") + B;
    ...
    if (!a.ui.version) {
        ...
        a.extend(a.ui, {
            plugin: {
                ...
                call: function(e, f, j) {
                    if ((f = e.plugins[f]) && e.element[0].parentNode) for (var g = 0; g < f.length; g++) e.options[f[g][0]] && f[g][1].apply(e.element, j)
                }
            },
            ...
            hasScroll: function(e, f) {
                ...
                var j = f && f === "left" ? "scrollLeft" : "scrollTop",
                    g = false;
            ...
            isOver: function(e, f, j, g, k, o) {
                return a.ui.isOverAxis(e, j, k) && a.ui.isOverAxis(f, g, o)
            }
        })
    }
})(jQuery);
(function(a, d) {
    ...
    a.widget = function(e, f, j) {
        ...
        a[g][e].prototype = a.extend(true, f, {
            namespace: g,
            widgetName: e,
            widgetEventPrefix: a[g][e].prototype.widgetEventPrefix || e,
            widgetBaseClass: k
        }, j);
    ...
    a.widget.bridge = function(e, f) {
        a.fn[e] = function(j) {
            var g = typeof j === "string",
                ...
                o = this;
            j = !g && k.length ? a.extend.apply(null, [true, j].concat(k)) : j;
            if (g && j.charAt(0) === "_") return o;
            g ? this.each(function() {
                var s = a.data(this, e),
                    q = s && a.isFunction(s[j]) ? s[j].apply(s, k) : s;
                if (q !== s && q !== d) {
                    o = q;
                    return false
                }
...
(function(a) {
    ...
    a.fn.position = function(f) {
        ...
        if (f.at[0] === "right") r.left += s;
        else if (f.at[0] === "center") r.left += s / 2;
        if (f.at[1] === "bottom") r.top += q;
        else if (f.at[1] === "center") r.top += q / 2;
        r.left += o[0];
        r.top += o[1];
        return this.each(function() {
            var v = a(this),
                t = v.outerWidth(),
                y = v.outerHeight(),
                E = parseInt(a.curCSS(this, "marginLeft", true)) || 0,
                G = parseInt(a.curCSS(this, "marginTop", true)) || 0,
                B = t + E + (parseInt(a.curCSS(this, "marginRight", true)) || 0),
                N = y + G + (parseInt(a.curCSS(this, "marginBottom", true)) || 0),
                ba = a.extend({}, r),
                L;
            if (f.my[0] === "right") ba.left -= t;
            else if (f.my[0] === "center") ba.left -= t / 2;
            if (f.my[1] === "bottom") ba.top -= y;
            else if (f.my[1] === "center") ba.top -= y / 2;
            ...
            a.each(["left", "top"], function(ja, K) {
                a.ui.position[k[ja]] && a.ui.position[k[ja]][K](ba, {
                    targetWidth: s,
                    targetHeight: q,
                    elemWidth: t,
                    elemHeight: y,
        ...
        flip: {
            left: function(f, j) {
                if (j.at[0] !== "center") {
                    var g = a(window);
                    g = j.collisionPosition.left + j.collisionWidth - g.width() - g.scrollLeft();
                    var k = j.my[0] === "left" ? -j.elemWidth : j.my[0] === "right" ? j.elemWidth : 0,
                        o = j.at[0] === "left" ? j.targetWidth : -j.targetWidth,
                        s = -2 * j.offset[0];
            ...
            top: function(f, j) {
                if (j.at[1] !== "center") {
                    var g = a(window);
                    g = j.collisionPosition.top + j.collisionHeight - g.height() - g.scrollTop();
                    var k = j.my[1] === "top" ? -j.elemHeight : j.my[1] === "bottom" ? j.elemHeight : 0,
                        o = j.at[1] === "top" ? j.targetHeight : -j.targetHeight,
                        s = -2 * j.offset[1];
    ...
    if (!a.offset.setOffset) {
        a.offset.setOffset = function(f, j) {
            ...
            var g = a(f),
                k = g.offset(),
                o = parseInt(a.curCSS(f, "top", true), 10) || 0,
                s = parseInt(a.curCSS(f, "left", true), 10) || 0;
            k = {
                top: j.top - k.top + o,
                left: j.left - k.left + s
            };
...
(function(a) {
    a.widget("ui.draggable", a.ui.mouse, {
        ...
        _convertPositionTo: function(d, b) {
            ...
            return {
                top: b.top + this.offset.relative.top * c + this.offset.parent.top * c - (a.browser.safari && a.browser.version < 526 && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : f ? 0 : e.scrollTop()) * c),
                left: b.left + this.offset.relative.left * c + this.offset.parent.left * c - (a.browser.safari && a.browser.version < 526 && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : f ? 0 : e.scrollLeft()) * c)
            }
        },
        _generatePosition: function(d) {
            ...
            if (this.originalPosition) {
                ...
                if (b.grid) {
                    ...
                    f = b.grid[0] ? this.originalPageX + Math.round((f - this.originalPageX) / b.grid[0]) * b.grid[0] : this.originalPageX;
                    f = g ? !(f - this.offset.click.left < g[0] || f - this.offset.click.left > g[2]) ? f : !(f - this.offset.click.left < g[0]) ? f - b.grid[0] : f + b.grid[0] : f
                }
            }
            return {
                top: j - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (a.browser.safari && a.browser.version < 526 && this.cssPosition == "fixed" ? 0 : this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : e ? 0 : c.scrollTop()),
    ...
    a.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(d) {
            ...
            if (b.scrollParent[0] != document && b.scrollParent[0].tagName != "HTML") {
                ...
                else if (d.pageY - b.overflowOffset.top < c.scrollSensitivity) b.scrollParent[0].scrollTop = e = b.scrollParent[0].scrollTop - c.scrollSpeed;
    ...
    a.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(d, b) {
            for (var c = a(this).data("draggable"), e = c.options, f = e.snapTolerance, j = b.offset.left, g = j + c.helperProportions.width, k = b.offset.top, o = k + c.helperProportions.height, s = c.snapElements.length - 1; s >= 0; s--) {
                var q = c.snapElements[s].left,
                    r = q + c.snapElements[s].width,
                    v = c.snapElements[s].top,
                    t = v + c.snapElements[s].height;
                if (q - f < j && j < r + f && v - f < k && k < t + f || q - f < j && j < r + f && v - f < o && o < t + f || q - f < g && g < r + f && v - f < k && k < t + f || q - f < g && g < r + f && v - f < o && o < t + f) {
                    if (e.snapMode != "inner") {
                        var y = Math.abs(v - o) <= f,
                            E = Math.abs(t - k) <= f,
                            G = Math.abs(q - g) <= f,
                            B = Math.abs(r - j) <= f;
                        if (y) b.position.top = c._convertPositionTo("relative", {
                            top: v - c.helperProportions.height,
                            left: 0
                        }).top - c.margins.top;
                        if (E) b.position.top = c._convertPositionTo("relative", {
                            top: t,
                            left: 0
                        }).top - c.margins.top;
                        if (G) b.position.left = c._convertPositionTo("relative", {
                            top: 0,
                            left: q - c.helperProportions.width
                        }).left - c.margins.left;
                        if (B) b.position.left = c._convertPositionTo("relative", {
                            top: 0,
                            left: r
                        }).left - c.margins.left
                    }
                    ...
                    if (!c.snapElements[s].snapping && (y || E || G || B || N)) c.options.snap.snap && c.options.snap.snap.call(c.element, d, a.extend(c._uiHash(), {
                        snapItem: c.snapElements[s].item
                    }));
                    c.snapElements[s].snapping = y || E || G || B || N
                } else {
                    c.snapElements[s].snapping && c.options.snap.release && c.options.snap.release.call(c.element, d, a.extend(c._uiHash(), {
                        snapItem: c.snapElements[s].item
                    }));
...
(function(a) {
    ...
    a.ui.intersect = function(d, b, c) {
        ...
        var e = (d.positionAbs || d.position.absolute).left,
            ...
            j = (d.positionAbs || d.position.absolute).top,
            g = j + d.helperProportions.height,
            k = b.offset.left,
            o = k + b.proportions.width,
            s = b.offset.top,
            q = s + b.proportions.height;
        switch (c) {
        case "fit":
            return k <= e && f <= o && s <= j && g <= q;
        case "intersect":
    ...
    a.ui.ddmanager = {
        ...
        prepareOffsets: function(d, b) {
            ...
            a: for (; j < c.length; j++) if (!(c[j].options.disabled || d && !c[j].accept.call(c[j].element[0], d.currentItem || d.element))) {
                ...
                if (c[j].visible) {
                    e == "mousedown" && c[j]._activate.call(c[j], b);
                    c[j].offset = c[j].element.offset();
                    c[j].proportions = {
                        width: c[j].element[0].offsetWidth,
                        height: c[j].element[0].offsetHeight
                    }
                }
            }
        },
...
(function(a) {
    a.widget("ui.resizable", a.ui.mouse, {
        ...
        _create: function() {
            ...
            if (this.handles.constructor == String) {
                ...
                for (var j = 0; j < f.length; j++) {
                    var g = a.trim(f[j]),
                        k = a('<div class="ui-resizable-handle ' + ("ui-resizable-" + g) + '"></div>');
                    /sw|se|ne|nw/.test(g) && k.css({
                        zIndex: ++e.zIndex
                    });
            ...
            this._renderAxis = function(o) {
                ...
                for (var s in this.handles) {
                    ...
                    if (this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i)) {
                        var q = a(this.handles[s], this.element),
                            r = 0;
        ...
        _mouseStart: function(c) {
            ...
            if (j.is(".ui-draggable") || /absolute/.test(j.css("position"))) j.css({
                position: "absolute",
                top: f.top,
                left: f.left
            });
            a.browser.opera && /relative/.test(j.css("position")) && j.css({
                position: "relative",
                top: "auto",
                left: "auto"
            });
        ...
        _mouseStop: function(c) {
            ...
            if (this._helper) {
                ...
                e.animate || this.element.css(a.extend(j, {
                    top: g,
                    left: f
                }));
        ...
        _updateCache: function(c) {
            ...
            if (b(c.height)) this.size.height = c.height;
        ...
        _updateRatio: function(c) {
            var e = this.position,
                f = this.size,
                j = this.axis;
            if (b(c.height)) c.width = c.height * this.aspectRatio;
            else if (b(c.width)) c.height = c.width / this.aspectRatio;
            if (j == "sw") {
        ...
        _respectSize: function(c) {
            var e = this._vBoundaries,
                f = this.axis,
                j = b(c.width) && e.maxWidth && e.maxWidth < c.width,
                g = b(c.height) && e.maxHeight && e.maxHeight < c.height,
                k = b(c.width) && e.minWidth && e.minWidth > c.width,
                o = b(c.height) && e.minHeight && e.minHeight > c.height;
        ...
        _proportionallyResize: function() {
            if (this._proportionallyResizeElements.length) for (var c = this.helper || this.element, e = 0; e < this._proportionallyResizeElements.length; e++) {
                ...
                if (!this.borderDif) {
                    var j = [f.css("borderTopWidth"), f.css("borderRightWidth"), f.css("borderBottomWidth"), f.css("borderLeftWidth")],
                        g = [f.css("paddingTop"), f.css("paddingRight"), f.css("paddingBottom"), f.css("paddingLeft")];
                    this.borderDif = a.map(j, function(k, o) {
                        var s = parseInt(k, 10) || 0,
                            q = parseInt(g[o], 10) || 0;
                        return s + q
                    })
                }
                a.browser.msie && (a(c).is(":hidden") || a(c).parents(":hidden").length) || f.css({
    ...
    a.ui.plugin.add("resizable", "alsoResize", {
        ...
        resize: function(c, e) {
            var f = a(this).data("resizable"),
                j = f.options,
                g = f.originalSize,
                k = f.originalPosition,
                o = {
                    height: f.size.height - g.height || 0,
                    width: f.size.width - g.width || 0,
                    top: f.position.top - k.top || 0,
                    left: f.position.left - k.left || 0
                },
                s = function(q, r) {
                    a(q).each(function() {
                        var v = a(this),
                            t = a(this).data("resizable-alsoresize"),
                            y = {},
                            E = r && r.length ? r : v.parents(e.originalElement[0]).length ? ["width", "height"] : ["width", "height", "top", "left"];
            ...
            typeof j.alsoResize == "object" && !j.alsoResize.nodeType ? a.each(j.alsoResize, function(q, r) {
                s(q, r)
            }) : s(j.alsoResize)
        },
        stop: function() {
            var c = a(this).data("resizable"),
                ...
                f = function(j) {
                    a(j).each(function() {
                        var g = a(this);
                        g.css({
                            position: g.data("resizable-alsoresize").position
                        })
                    })
                };
    ...
    a.ui.plugin.add("resizable", "animate", {
        stop: function(c) {
            var e = a(this).data("resizable"),
                f = e.options,
                j = e._proportionallyResizeElements,
                g = j.length && /textarea/i.test(j[0].nodeName),
                k = g && a.ui.hasScroll(j[0], "left") ? 0 : e.sizeDiff.height;
            g = {
            ...
            e.element.animate(a.extend(g, o && k ? {
                top: o,
                left: k
            } : {}), {
    ...
    a.ui.plugin.add("resizable", "containment", {
        start: function() {
            var c = a(this).data("resizable"),
                e = c.element,
                f = c.options.containment;
            if (e = f instanceof a ? f.get(0) : /parent/.test(f) ? e.parent().get(0) : f) {
                ...
                if (/document/.test(f) || f == document) {
                    ...
                    c.containerSize = {
                        height: j.innerHeight() - g[3],
                        width: j.innerWidth() - g[1]
                    };
                    f = c.containerOffset;
                    var k = c.containerSize.height,
        ...
        resize: function(c) {
            ...
            if (g.left < (e._helper ? j.left : 0)) {
                e.size.width += e._helper ? e.position.left - j.left : e.position.left - k.left;
            ...
            j = Math.abs((e._helper ? e.offset.top - k.top : e.offset.top - j.top) + e.sizeDiff.height);
        ...
        stop: function() {
            var c = a(this).data("resizable"),
                e = c.options,
                f = c.containerOffset,
                j = c.containerPosition,
                g = c.containerElement,
                k = a(c.helper),
                o = k.offset(),
                s = k.outerWidth() - c.sizeDiff.width;
            k = k.outerHeight() - c.sizeDiff.height;
            c._helper && !e.animate && /relative/.test(g.css("position")) && a(this).css({
                left: o.left - j.left - f.left,
                width: s,
                height: k
            });
            c._helper && !e.animate && /static/.test(g.css("position")) && a(this).css({
                left: o.left - j.left - f.left,
                width: s,
                height: k
            })
    ...
    a.ui.plugin.add("resizable", "iframeFix", {
        start: function() {
            var c = a(this).data("resizable").options;
            a(c.iframeFix === true ? "iframe" : c.iframeFix).each(function() {
                a('<div class="ui-resizable-iframeFix" style="background: #fff;"></div>').css({
                    width: this.offsetWidth + "px",
                    height: this.offsetHeight + "px",
                    position: "absolute",
                    opacity: "0.001",
...
(function(a) {
    a.widget("ui.sortable", a.ui.mouse, {
        ...
        _mouseDrag: function(d) {
            ...
            if (this.options.scroll) {
                ...
                if (this.scrollParent[0] != document && this.scrollParent[0].tagName != "HTML") {
                    if (this.overflowOffset.top + this.scrollParent[0].offsetHeight - d.pageY < b.scrollSensitivity) this.scrollParent[0].scrollTop = c = this.scrollParent[0].scrollTop + b.scrollSpeed;
                    else if (d.pageY - this.overflowOffset.top < b.scrollSensitivity) this.scrollParent[0].scrollTop = c = this.scrollParent[0].scrollTop - b.scrollSpeed;
                    if (this.overflowOffset.left + this.scrollParent[0].offsetWidth - d.pageX < b.scrollSensitivity) this.scrollParent[0].scrollLeft = c = this.scrollParent[0].scrollLeft + b.scrollSpeed;
                    else if (d.pageX - this.overflowOffset.left < b.scrollSensitivity) this.scrollParent[0].scrollLeft = c = this.scrollParent[0].scrollLeft - b.scrollSpeed
                } else {
                    if (d.pageY - a(document).scrollTop() < b.scrollSensitivity) c = a(document).scrollTop(a(document).scrollTop() - b.scrollSpeed);
                    else if (a(window).height() - (d.pageY - a(document).scrollTop()) < b.scrollSensitivity) c = a(document).scrollTop(a(document).scrollTop() + b.scrollSpeed);
                    if (d.pageX - a(document).scrollLeft() < b.scrollSensitivity) c = a(document).scrollLeft(a(document).scrollLeft() - b.scrollSpeed);
                    else if (a(window).width() - (d.pageX - a(document).scrollLeft()) < b.scrollSensitivity) c = a(document).scrollLeft(a(document).scrollLeft() + b.scrollSpeed)
                }
                c !== false && a.ui.ddmanager && !b.dropBehaviour && a.ui.ddmanager.prepareOffsets(this, d)
            }
            this.positionAbs = this._convertPositionTo("absolute");
            if (!this.options.axis || this.options.axis != "y") this.helper[0].style.left = this.position.left + "px";
            if (!this.options.axis || this.options.axis != "x") this.helper[0].style.top = this.position.top + "px";
            for (b = this.items.length - 1; b >= 0; b--) {
                ...
                if (f) if (e != this.currentItem[0] && this.placeholder[f == 1 ? "next" : "prev"]()[0] != e && !a.ui.contains(this.placeholder[0], e) && (this.options.type == "semi-dynamic" ? !a.ui.contains(this.element[0], e) : true)) {
        ...
        _intersectsWith: function(d) {
            ...
            return this.options.tolerance == "pointer" || this.options.forcePointerForContainers || this.options.tolerance != "pointer" && this.helperProportions[this.floating ? "width" : "height"] > d[this.floating ? "width" : "height"] ? s : j < b + this.helperProportions.width / 2 && c - this.helperProportions.width / 2 < g && k < e + this.helperProportions.height / 2 && f - this.helperProportions.height / 2 < o
        },
        ...
        _refreshItems: function(d) {
            ...
            if (e) for (var f = e.length - 1; f >= 0; f--) for (var j = a(e[f]), g = j.length - 1; g >= 0; g--) {
                ...
                if (k && k != this && !k.options.disabled) {
                    c.push([a.isFunction(k.options.items) ? k.options.items.call(k.element[0], d, {
                        item: this.currentItem
        ...
        _createPlaceholder: function(d) {
            ...
            if (!c.placeholder || c.placeholder.constructor == String) {
                ...
                c.placeholder = {
                    element: function() {
                        var f = a(document.createElement(b.currentItem[0].nodeName)).addClass(e || b.currentItem[0].className + " ui-sortable-placeholder").removeClass("ui-sortable-helper")[0];
        ...
        _convertPositionTo: function(d, b) {
            ...
            var c = d == "absolute" ? 1 : -1,
                ...
                f = /(html|body)/i.test(e[0].tagName);
            return {
                top: b.top + this.offset.relative.top * c + this.offset.parent.top * c - (a.browser.safari && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : f ? 0 : e.scrollTop()) * c),
                left: b.left + this.offset.relative.left * c + this.offset.parent.left * c - (a.browser.safari && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : f ? 0 : e.scrollLeft()) * c)
            }
        },
        _generatePosition: function(d) {
            var b = this.options,
            ...
            return {
                ...
                left: f - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (a.browser.safari && this.cssPosition == "fixed" ? 0 : this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : e ? 0 : c.scrollLeft())
            }
        },
        ...
        _create: function() {
            ...
            this.menu = a("<ul></ul>").addClass("ui-autocomplete").appendTo(a(this.options.appendTo || "body", c)[0]).mousedown(function(f) {
                ...
                focus: function(f, j) {
                    ...
                    false !== b._trigger("focus", f, {
                        item: g
                    }) && /^key/.test(f.originalEvent.type) && b.element.val(g.value)
                },
    ...
    a.widget("ui.menu", {
        ...
        activate: function(d, b) {
            ...
            if (this.hasScroll()) {
                ...
                if (c < 0) this.element.scrollTop(e + c);
                else c >= f && this.element.scrollTop(e + c - f + b.height())
            }
    ...
    a.widget("ui.slider", a.ui.mouse, {
        ...
        _create: function() {
            ...
            this.handles.keydown(function(g) {
                var k = true,
                    o = a(this).data("index.ui-slider-handle"),
                    s, q, r;
                if (!d.options.disabled) {
                    ...
                    r = d.options.step;
                    s = d.options.values && d.options.values.length ? q = d.values(o) : q = d.value();
                    switch (g.keyCode) {
                    case a.ui.keyCode.HOME:
                        q = d._valueMin();
                        break;
        ...
        _mouseCapture: function(d) {
            ...
            this._clickOffset = !a(d.target).parents().andSelf().is(".ui-slider-handle") ? {
                ...
                left: d.pageX - b.left - f.width() / 2,
                top: d.pageY - b.top - f.height() / 2 - (parseInt(f.css("borderTopWidth"), 10) || 0) - (parseInt(f.css("borderBottomWidth"), 10) || 0) + (parseInt(f.css("marginTop"), 10) || 0)
            };
        ...
        _refreshValue: function() {
            ...
            if (this.options.values && this.options.values.length) this.handles.each(function(q) {
                ...
                if (c.options.range === true) if (c.orientation === "horizontal") {
                    if (q === 0) c.range.stop(1, 1)[e ? "animate" : "css"]({
                        left: f + "%"
                    }, b.animate);
                    if (q === 1) c.range[e ? "animate" : "css"]({
                        width: f - g + "%"
                    }, {
                        queue: false,
                        duration: b.animate
...
(function(a, d) {
    ...
    function c(g) {
        return g.bind("mouseout", function(k) {
    ...
    a.extend(b.prototype, {
        ...
        _attachDatepicker: function(g, k) {
            ...
            if (s == "input") this._connectDatepicker(g, v);
            else q && this._inlineDatepicker(g, v)
        },
        _newInst: function(g, k) {
            return {
                id: g[0].id.replace(/([^A-Za-z0-9_-])/g, "\\\\$1"),
                input: g,
                selectedDay: 0,
                selectedMonth: 0,
                selectedYear: 0,
                ...
                drawYear: 0,
                inline: k,
                dpDiv: !k ? this.dpDiv : c(a('<div class="' + this._inlineClass + ' ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"></div>'))
            }
        },
        _connectDatepicker: function(g, k) {
            ...
            if (!o.hasClass(this.markerClassName)) {
                ...
                o.addClass(this.markerClassName).keydown(this._doKeyDown).keypress(this._doKeyPress).keyup(this._doKeyUp).bind("setData.datepicker", function(s, q, r) {
                    k.settings[q] = r
        ...
        _attachments: function(g, k) {
            ...
            if (o == "focus" || o == "both") g.focus(this._showDatepicker);
            if (o == "button" || o == "both") {
                ...
                k.trigger = a(this._get(k, "buttonImageOnly") ? a("<img/>").addClass(this._triggerClass).attr({
                    ...
                    alt: o,
                    title: o
                }) : a('<button type="button"></button>').addClass(this._triggerClass).html(q == "" ? o : a("<img/>").attr({
                    src: q,
                    alt: o,
                    title: o
                })));
                ...
                k.trigger.click(function() {
                    a.datepicker._datepickerShowing && a.datepicker._lastInput == g[0] ? a.datepicker._hideDatepicker() : a.datepicker._showDatepicker(g[0]);
                    return false
                })
            }
        },
        ...
        _optionDatepicker: function(g, k, o) {
            ...
            if (s) {
                ...
                var r = this._getDateDatepicker(g, true),
                    v = this._getMinMaxDate(s, "min"),
        ...
        _doKeyDown: function(g) {
            ...
            default:
                o = false
            } else if (g.keyCode == 36 && g.ctrlKey) a.datepicker._showDatepicker(this);
            else o = false;
            if (o) {
                g.preventDefault();
                g.stopPropagation()
        ...
        _doKeyPress: function(g) {
            ...
            if (a.datepicker._get(k, "constrainInput")) {
                ...
                var o = String.fromCharCode(g.charCode == d ? g.keyCode : g.charCode);
        ...
        _showDatepicker: function(g) {
            g = g.target || g;
            if (g.nodeName.toLowerCase() != "input") g = a("input", g.parentNode)[0];
            if (!(a.datepicker._isDisabledDatepicker(g) || a.datepicker._lastInput == g)) {
                ...
                if (o !== false) {
                    ...
                    if (!k.inline) {
                        ...
                        var q = a.datepicker._get(k, "duration"),
                            r = function() {
        ...
        _updateDatepicker: function(g) {
            ...
            g == a.datepicker._curInst && a.datepicker._datepickerShowing && g.input && g.input.is(":visible") && !g.input.is(":disabled") && g.input[0] != document.activeElement && g.input.focus();
            if (g.yearshtml) {
                var s = g.yearshtml;
                setTimeout(function() {
        ...
        _checkOffset: function(g, k, o) {
            var s = g.dpDiv.outerWidth(),
                q = g.dpDiv.outerHeight(),
                r = g.input ? g.input.outerWidth() : 0,
                v = g.input ? g.input.outerHeight() : 0,
                t = document.documentElement.clientWidth + a(document).scrollLeft(),
                y = document.documentElement.clientHeight + a(document).scrollTop();
        ...
        _findPos: function(g) {
            for (var k = this._get(this._getInst(g), "isRTL"); g && (g.type == "hidden" || g.nodeType != 1 || a.expr.filters.hidden(g));) g = g[k ? "previousSibling" : "nextSibling"];
            g = a(g).offset();
            return [g.left, g.top]
        },
        ...
        _adjustDate: function(g, k, o) {
            ...
            if (!this._isDisabledDatepicker(g[0])) {
                this._adjustInstDate(s, k + (o == "M" ? this._get(s, "showCurrentAtPos") : 0), o);
                this._updateDatepicker(s)
            }
        },
        ...
        _selectMonthYear: function(g, k, o) {
            g = a(g);
            var s = this._getInst(g[0]);
            s["selected" + (o == "M" ? "Month" : "Year")] = s["draw" + (o == "M" ? "Month" : "Year")] = parseInt(k.options[k.selectedIndex].value, 10);
        ...
        _selectDate: function(g, k) {
            ...
            if (s) s.apply(o.input ? o.input[0] : null, [k, o]);
            else o.input && o.input.trigger("change");
        ...
        _updateAlternate: function(g) {
            var k = this._get(g, "altField");
            if (k) {
                var o = this._get(g, "altFormat") || this._get(g, "dateFormat"),
                    s = this._getDate(g),
                    q = this.formatDate(o, s, this._getFormatConfig(g));
                a(k).each(function() {
                    a(this).val(q)
                })
            }
        ...
        parseDate: function(g, k, o) {
            ...
            for (var q = (o ? o.dayNamesShort : null) || this._defaults.dayNamesShort, r = (o ? o.dayNames : null) || this._defaults.dayNames, v = (o ? o.monthNamesShort : null) || this._defaults.monthNamesShort, t = (o ? o.monthNames : null) || this._defaults.monthNames, y = o = -1, E = -1, G = -1, B = false, N = function(da) {
                    ...
                    K++
                }, K = 0, Z = 0; Z < g.length; Z++) if (B) if (g.charAt(Z) == "'" && !N("'")) B = false;
            else ja();
            else switch (g.charAt(Z)) {
            case "d":
                E = ba("d");
                break;
            case "D":
            ...
            else if (o < 100) o += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (o <= s ? 0 : -100);
            if (G > -1) {
                y = 1;
                E = G;
                do {
        ...
        formatDate: function(g, k, o) {
            if (!k) return "";
            var s = (o ? o.dayNamesShort : null) || this._defaults.dayNamesShort,
                q = (o ? o.dayNames : null) || this._defaults.dayNames,
                r = (o ? o.monthNamesShort : null) || this._defaults.monthNamesShort;
            ...
            var v = function(N) {
                ...
                E = "",
                G = false;
            if (k) for (var B = 0; B < g.length; B++) if (G) if (g.charAt(B) == "'" && !v("'")) G = false;
            else E += g.charAt(B);
            else switch (g.charAt(B)) {
            case "d":
                E += t("d", k.getDate(), 2);
                break;
            case "D":
                ...
                break;
            case "o":
                E += t("o", Math.round(((new Date(k.getFullYear(), k.getMonth(), k.getDate())).getTime() - (new Date(k.getFullYear(), 0, 0)).getTime()) / 864E5), 3);
                break;
            case "m":
        ...
        _possibleChars: function(g) {
            for (var k = "", o = false, s = function(r) {
                    (r = q + 1 < g.length && g.charAt(q + 1) == r) && q++;
                    return r
                }, q = 0; q < g.length; q++) if (o) if (g.charAt(q) == "'" && !s("'")) o = false;
            else k += g.charAt(q);
            else switch (g.charAt(q)) {
            case "d":
            case "m":
            case "y":
            case "@":
        ...
        _setDateFromField: function(g, k) {
            if (g.input.val() != g.lastVal) {
                var o = this._get(g, "dateFormat"),
                    s = g.lastVal = g.input ? g.input.val() : null,
                    q, r;
        ...
        _determineDate: function(g, k, o) {
            var s = function(r) {
                ...
                q = function(r) {
                    ...
                    var t = (r.toLowerCase().match(/^c/) ? a.datepicker._getDate(g) : null) || new Date,
                        y = t.getFullYear(),
                        E = t.getMonth();
                    t = t.getDate();
        ...
        _getDate: function(g) {
            return !g.currentYear || g.input && g.input.val() == "" ? null : this._daylightSavingAdjust(new Date(g.currentYear, g.currentMonth, g.currentDay))
        },
        _generateHTML: function(g) {
            var k = new Date;
            k = this._daylightSavingAdjust(new Date(k.getFullYear(), k.getMonth(), k.getDate()));
            var o = this._get(g, "isRTL"),
                s = this._get(g, "showButtonPanel"),
                q = this._get(g, "hideIfNoPrevNext"),
                r = this._get(g, "navigationAsDateFormat"),
                v = this._getNumberOfMonths(g),
                t = this._get(g, "showCurrentAtPos"),
                y = this._get(g, "stepMonths"),
                E = v[0] != 1 || v[1] != 1,
                G = this._daylightSavingAdjust(!g.currentDay ? new Date(9999, 9, 9) : new Date(g.currentYear, g.currentMonth, g.currentDay)),
                B = this._getMinMaxDate(g, "min"),
                N = this._getMinMaxDate(g, "max");
            t = g.drawMonth - t;
            var ba = g.drawYear;
            if (t < 0) {
                t += 12;
            ...
            L = !r ? L : this.formatDate(L, this._daylightSavingAdjust(new Date(ba, t - y, 1)), this._getFormatConfig(g));
            ...
            ja = !r ? ja : this.formatDate(ja, this._daylightSavingAdjust(new Date(ba, t + y, 1)), this._getFormatConfig(g));
            ...
            s = s ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (o ? r : "") + (this._isInRange(g, ja) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_' + f + ".datepicker._gotoToday('#" + g.id + "');\">" + y + "</button>" : "") + (o ? "" : r) + "</div>" : "";
            r = parseInt(this._get(g, "firstDay"), 10);
            r = isNaN(r) ? 0 : r;
            y = this._get(g, "showWeek");
            ja = this._get(g, "dayNames");
            this._get(g, "dayNamesShort");
            var K = this._get(g, "dayNamesMin"),
                Z = this._get(g, "monthNames"),
                X = this._get(g, "monthNamesShort"),
                da = this._get(g, "beforeShowDay"),
                W = this._get(g, "showOtherMonths"),
                ra = this._get(g, "selectOtherMonths");
            this._get(g, "calculateWeek");
            for (var Y = this._getDefaultDate(g), m = "", P = 0; P < v[0]; P++) {
                var la = "";
                this.maxRows = 4;
                for (var wa = 0; wa < v[1]; wa++) {
                    var Aa = this._daylightSavingAdjust(new Date(ba, t, g.selectedDay)),
                        za = " ui-corner-all",
                        C = "";
                    if (E) {
                    ...
                    C += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + za + '">' + (/all|left/.test(za) && P == 0 ? o ? q : L : "") + (/all|right/.test(za) && P == 0 ? o ? L : q : "") + this._generateMonthYearHeader(g, t, ba, B, N, P > 0 || wa > 0, Z, X) + '</div><table class="ui-datepicker-calendar"><thead><tr>';
                    ...
                    if (ba == g.selectedYear && t == g.selectedMonth) g.selectedDay = Math.min(g.selectedDay, S);
                    ...
                    for (var pa = 0; pa < S; pa++) {
                        ...
                        for (za = 0; za < 7; za++) {
                            var fa = da ? da.apply(g.input ? g.input[0] : null, [ua]) : [true, ""],
                                ma = ua.getMonth() != t,
                                va = ma && !ra || !fa[0] || B && ua < B || N && ua > N;
                            Q += '<td class="' + ((za + r + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (ma ? " ui-datepicker-other-month" : "") + (ua.getTime() == Aa.getTime() && t == g.selectedMonth && g._keyEvent || Y.getTime() == ua.getTime() && Y.getTime() == Aa.getTime() ? " " + this._dayOverClass : "") + (va ? " " + this._unselectableClass + " ui-state-disabled" : "") + (ma && !W ? "" : " " + fa[1] + (ua.getTime() == G.getTime() ? " " + this._currentClass : "") + (ua.getTime() == k.getTime() ? " ui-datepicker-today" : "")) + '"' + ((!ma || W) && fa[2] ? ' title="' + fa[2] + '"' : "") + (va ? "" : ' onclick="DP_jQuery_' + f + ".datepicker._selectDay('#" + g.id + "'," + ua.getMonth() + "," + ua.getFullYear() + ', this);return false;"') + ">" + (ma && !W ? "&#xa0;" : va ? '<span class="ui-state-default">' + ua.getDate() + "</span>" : '<a class="ui-state-default' + (ua.getTime() == k.getTime() ? " ui-state-highlight" : "") + (ua.getTime() == G.getTime() ? " ui-state-active" : "") + (ma ? " ui-priority-secondary" : "") + '" href="#">' + ua.getDate() + "</a>") + "</td>";
                    ...
                    C += "</tbody></table>" + (E ? "</div>" + (v[0] > 0 && wa == v[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : "") : "");
                    la += C
                }
                m += la
            }
        ...
        _generateMonthYearHeader: function(g, k, o, s, q, r, v, t) {
            var y = this._get(g, "changeMonth"),
                E = this._get(g, "changeYear"),
                G = this._get(g, "showMonthAfterYear"),
                B = '<div class="ui-datepicker-title">',
                N = "";
            if (r || !y) N += '<span class="ui-datepicker-month">' + v[k] + "</span>";
            else {
                v = s && s.getFullYear() == o;
            ...
            if (!g.yearshtml) {
                g.yearshtml = "";
                if (r || !E) B += '<span class="ui-datepicker-year">' + o + "</span>";
                else {
                    t = this._get(g, "yearRange").split(":");
                    ...
                    for (g.yearshtml += '<select class="ui-datepicker-year" onchange="DP_jQuery_' + f + ".datepicker._selectMonthYear('#" + g.id + "', this, 'Y');\" >"; k <= t; k++) g.yearshtml += '<option value="' + k + '"' + (k == o ? ' selected="selected"' : "") + ">" + k + "</option>";
                    g.yearshtml += "</select>";
                    B += g.yearshtml;
                    g.yearshtml = null
                }
        ...
        _adjustInstDate: function(g, k, o) {
            var s = g.drawYear + (o == "Y" ? k : 0),
                q = g.drawMonth + (o == "M" ? k : 0);
            ...
            if (o == "M" || o == "Y") this._notifyChange(g)
        },
        _restrictMinMax: function(g, k) {
            var o = this._getMinMaxDate(g, "min"),
                s = this._getMinMaxDate(g, "max");
            o = o && k < o ? o : k;
            return o = s && o > s ? s : o
        },
        ...
        _isInRange: function(g, k) {
            var o = this._getMinMaxDate(g, "min"),
                s = this._getMinMaxDate(g, "max");
            return (!o || k.getTime() >= o.getTime()) && (!s || k.getTime() <= s.getTime())
        },
        _getFormatConfig: function(g) {
            ...
            return {
                shortYearCutoff: k,
                dayNamesShort: this._get(g, "dayNamesShort"),
                dayNames: this._get(g, "dayNames"),
                monthNamesShort: this._get(g, "monthNamesShort"),
                monthNames: this._get(g, "monthNames")
            }
        },
        _formatDate: function(g, k, o, s) {
            ...
            k = k ? typeof k == "object" ? k : this._daylightSavingAdjust(new Date(s, o, k)) : this._daylightSavingAdjust(new Date(g.currentYear, g.currentMonth, g.currentDay));
    ...
    a.fn.datepicker = function(g) {
        ...
        if (typeof g == "string" && (g == "isDisabled" || g == "getDate" || g == "widget")) return a.datepicker["_" + g + "Datepicker"].apply(a.datepicker, [this[0]].concat(k));
...
function(a, d) {
    function b(q) {
        ...
        if (r = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(q)) return [parseInt(r[1], 16), parseInt(r[2], 16), parseInt(r[3], 16)];
    ...
    a.fn.extend({
        ...
        addClass: function(q, r, v, t) {
            return r ? a.effects.animateClass.apply(this, [{
                add: q
            },
            r, v, t]) : this._addClass(q)
        },
        _removeClass: a.fn.removeClass,
        removeClass: function(q, r, v, t) {
            return r ? a.effects.animateClass.apply(this, [{
                remove: q
            },
            r, v, t]) : this._removeClass(q)
        },
        _toggleClass: a.fn.toggleClass,
        toggleClass: function(q, r, v, t, y) {
            return typeof r == "boolean" || r === d ? v ? a.effects.animateClass.apply(this, [r ? {
                add: q
            } : {
                remove: q
            },
            v, t, y]) : this._toggleClass(q, r) : a.effects.animateClass.apply(this, [{
                toggle: q
            },
            r, v, t])
        },
    ...
    a.fn.extend({
        ...
        _show: a.fn.show,
        show: function(q) {
            if (g(q)) return this._show.apply(this, arguments);
            else {
                var r = j.apply(this, arguments);
                r[1].mode = "show";
        ...
        _hide: a.fn.hide,
        hide: function(q) {
            if (g(q)) return this._hide.apply(this, arguments);
            else {
                var r = j.apply(this, arguments);
                r[1].mode = "hide";
                return this.effect.apply(this, r)
        ...
        toggle: function(q) {
            if (g(q) || typeof q === "boolean" || a.isFunction(q)) return this.__toggle.apply(this, arguments);
            else {
                var r = j.apply(this, arguments);
                r[1].mode = "toggle";
                return this.effect.apply(this, r)
    ...
    a.extend(a.easing, {
        ...
        easeInOutBounce: function(q, r, v, t, y) {
            ...
            return a.easing.easeOutBounce(q, r * 2 - y, 0, t, y) * 0.5 + t * 0.5 + v
        }
    })
}(jQuery);
(function(a) {
    ...
    a.getScrollbarWidth = function() {
        if (!d) if (a.browser.msie) {
            var b = a('<textarea cols="10" rows="2"></textarea>').css({
                position: "absolute",
                top: -1000,
                left: -1000
            }).appendTo("body"),
...
(function(a) {
    a.fn.drag = function(e, f, j) {
        var g = typeof e == "string" ? e : "",
            k = a.isFunction(e) ? e : a.isFunction(f) ? f : null;
        ...
        c = b.drag = {
            ...
            interaction: function(e, f) {
                return {
                    ...
                    droppable: [],
                    offset: a(e)[f.relative ? "position" : "offset"]() || {
                        top: 0,
                        left: 0
                    }
                }
    ...
    c.callback.prototype = {
        update: function() {
            b.drop && this.available.length && a.each(this.available, function(e) {
...
(function(a) {
    ...
    var d = a.event,
        ...
        c = a.event.special.drop = {
            ...
            tolerate: function(e) {
                var f, j, g, k, o, s, q = 0,
                    r, v = e.interactions.length,
                    t = [c.event.pageX, c.event.pageY],
                    y = c.tolerance || c.modes[c.mode];
                do if (r = e.interactions[q]) {
                    ...
                    do if (k = o[f]) if (k.winner && r.drop.length < c.multi) {
                        ...
                        b.drag.hijack(c.event, "dropend", e, q, k.elem);
                        k.active[q] = 0;
                        k.anyactive -= 1
                    }
                    while (++f < s)
                ...
                while (++q < v);
                if (c.last && t[0] == c.last.pageX && t[1] == c.last.pageY) delete c.timer;
...
(function(a) {
    ...
    a.localize = function(f, j) {
        ...
        function k(G, B, N) {
            ...
            if (b[G]) q(b[G]);
            else if (c[G]) c[G].done(ba);
            else c[G] = a.localize.jsonpCallback ? a.ajax({
                url: window.gsConfig.assetHost + G,
                async: true,
                dataType: "jsonp",
                jsonp: false,
                jsonpCallback: a.localize.jsonpCallback + N,
                data: null
            }).done(ba).fail(L) : a.ajax({
                url: G,
                async: true,
                dataType: "json",
                data: null
        ...
        function o(G) {
            ...
            t.each(function() {
                ...
                if (N) N.setString(B);
                else if (elem.data("localize-text") !== B) {
        ...
        function q(G) {
            if (j.callback) j.callback === "titleCallback" ? s(G) : j.callback(G, o);
            else o(G)
        }
        function r(G, B) {
            for (var N = G.split(/\./), ba = B; N.length > 0;) if (ba) ba = ba[N.shift()];
            else return null;
            return ba
        }
        function v(G) {
        ...
        j.skipLanguage && E.match(v(j.skipLanguage)) || g(f, E, 1)
    };
...
(function(a) {
    function d(b) {
        if (typeof b.data === "string") {
            var c = b.handler,
                e = b.data.toLowerCase().split(" ");
            b.handler = function(f) {
                if (!(this !== f.target && /textarea|select/i.test(f.target.nodeName) && f.target.type === "text")) {
                    var j = f.type !== "keypress" && a.hotkeys.specialKeys[f.which],
                        g = String.fromCharCode(f.which).toLowerCase(),
                        k = "",
                        o = {};
...
(function(a) {
    ...
    a.event.special.mousewheel = {
        setup: function() {
            if (this.addEventListener) for (var e = b.length; e;) this.addEventListener(b[--e], d, false);
            else this.onmousewheel = d
        },
        teardown: function() {
            if (this.removeEventListener) for (var e = b.length; e;) this.removeEventListener(b[--e], d, false);
...
(function(a) {
    ...
    a.fn.gsQueue = function(b, c) {
        ...
        this.updateItem = function(B) {
            var N = B[b.dataKey];
            if (N && c[N]) c[N] = B;
            else console.warn("jquery-queue. item has invalid dataKey. settings:", b.dataKey, "item key:", B[b.dataKey])
        };
        this.updateScrollbar = function() {
            var B = a("#queue").height(),
                N = b.itemWidth,
                ba = b.activeItemWidth,
                L = parseInt(e.css("padding-left"), 10);
            N = N * c.length + ba + L;
            a(f).width(Math.max(N, e.outerWidth() - L));
            if (j) j.update({
                axis: "x",
                contentSize: N
            });
            else j = a(d).tinyscrollbar({
                axis: "x",
                contentSize: N,
                animationOptions: {
                    duration: 50,
        ...
        this.render = function(B, N) {
            ...
            if (!(!N && ba - E < 60 && !r)) if (!(!N && !r && !c.length)) {
                ...
                ba = e.scrollLeft();
                var L = e.width(),
                    ja = e.filter(":animated").length,
                    K = Math.max(0, ba - L * 1.1),
                    Z = Math.min(ba + L * 1.4, c.length * b.itemWidth),
                    X = 0;
                L = 0;
                var da, W;
                ...
                for (da in v) if (v.hasOwnProperty(da)) {
                    W = a(v[da]);
                    K = W.data("queueIndex");
                    if (K > s.ceil || K < s.floor || K > Z || c[K][b.dataKey] != da) {
                        if (!y[da]) {
                            f[0].removeChild(W[0]);
                            X++
                        }
                        if (K > Z || c[K][b.dataKey] != da) delete v[da];
                        else y[da] = 1
                    }
                }
...
(function(a) {
    var d = function() {
            var b = a("<div style='position:absolute; top:-10000px; left:-10000px; width:100px; height:100px; overflow:scroll;'></div>").appendTo("body"),
                c = {
    ...
    a.fn.slickbox = function(b, c) {
        ...
        this.calculateGaps = function() {
            var L = Math.max(1, Math.floor((f.outerWidth() - r * 2 - b.minHorizontalGap) / (b.itemWidth + b.minHorizontalGap))),
                ja = Math.max(1, Math.floor((f.outerWidth() - r * 2 - b.maxHorizontalGap) / (b.itemWidth + b.maxHorizontalGap)));
            t = Math.max(L, ja);
        ...
        this.scrollTo = function(L, ja) {
            ja ? g.scrollLeft(L) : g.stop().animate({
                scrollTop: L
            }, "slow", "linear", function() {
                e.render()
            });
        ...
        this.render = function() {
            ...
            e.renderTimeout = setTimeout(function() {
                var L = Math.max(0, g.scrollTop() - y),
                    ja = Math.max(L + 1, g.scrollTop() + g.height() - y);
                if (b.displayRows > -1) {
                ...
                if (ba) {
                    ...
                    if (K >= e.sorted.length || elTop + b.itemHeight < L || elTop - b.itemHeight > ja) {
                        j.get(0).removeChild(el);
                        delete k[K]
                    }
                }
                for (i = B.floor; i < B.ceil && i < e.sorted.length; i++) {
                    if (L = e.getFromCache(i)) N && a(L).css({
                        left: e.leftOffset(i),
                        top: e.topOffset(i)
                    });
                    else {
        ...
        this.itemWrapper = function(L, ja) {
            ...
            da.innerHTML = ['<li class="', K, '"', X, ' style="position:absolute; top: ' + e.topOffset(ja) + "px; left: " + e.leftOffset(ja) + "px; z-index: " + (5E3 - ja) + '" rel="', ja, '"><div class="slickbox-item-content">', Z, "</div>", W, "</li>"].join("");
    ...
    a.fn.tinyscrollbar = function(d) {
        ...
        function g(L) {
            if (!(q.ratio >= 1) && r.ratio > 0) {
                ...
                t.obj.css(E, N.now);
                E == "top" ? s.obj.stop().animate({
                    scrollTop: B
                }, k.animationOptions) : s.obj.stop().animate({
                    scrollLeft: B
                }, k.animationOptions)
            }
            return false
        ...
        this.update = function(L) {
            ...
            q[k.axis] = k.contentSize && k.contentSize >= 0 ? k.contentSize : q.obj[0]["scroll" + G];
            ...
            B = k.contentSize && k.contentSize >= 0 ? k.contentSize > s.obj["outer" + G]() ? -q.obj.offset()[E] : 0 : q.obj["outer" + G]() > s.obj["outer" + G]() ? -q.obj.offset()[E] : 0;
            this.redraw()
        };
...
(function(a) {
    ...
    a.fn.scrollTo = function(c, e, f) {
        ...
        return this._scrollable().each(function() {
            ...
            a.each(f.axis.split(""), function(v, t) {
                ...
                if (/^\d+$/.test(q[G])) q[G] = q[G] <= 0 ? 0 : Math.min(q[G], N);
                if (!v && f.queue) {
    ...
    b.max = function(c, e) {
        ...
        f = "client" + f;
        var g = c.ownerDocument.documentElement,
            k = c.ownerDocument.body;
...
(function(a) {
    a.fn.konami = function(d, b) {
        ...
        this.checkCode = function(e) {
            ...
            if (e.keyCode == b.code[b.step]) b.step++;
            else b.step = 0;
...
QRCode.prototype = {
    ...
    setupPositionProbePattern: function(a, d) {
        for (var b = -1; b <= 7; b++) if (!(a + b <= -1 || this.moduleCount <= a + b)) for (var c = -1; c <= 7; c++) d + c <= -1 || this.moduleCount <= d + c || (this.modules[a + b][d + c] = 0 <= b && b <= 6 && (c == 0 || c == 6) || 0 <= c && c <= 6 && (b == 0 || b == 6) || 2 <= b && b <= 4 && 2 <= c && c <= 4 ? true : false)
    },
    ...
    setupPositionAdjustPattern: function() {
        for (var a = QRUtil.getPatternPosition(this.typeNumber), d = 0; d < a.length; d++) for (var b = 0; b < a.length; b++) {
            var c = a[d],
                e = a[b];
            if (this.modules[c][e] == null) for (var f = -2; f <= 2; f++) for (var j = -2; j <= 2; j++) this.modules[c + f][e + j] = f == -2 || f == 2 || j == -2 || j == 2 || f == 0 && j == 0 ? true : false
        }
    },
    ...
    setupTypeInfo: function(a, d) {
        for (var b = QRUtil.getBCHTypeInfo(this.errorCorrectLevel << 3 | d), c = 0; c < 15; c++) {
            var e = !a && (b >> c & 1) == 1;
            if (c < 6) this.modules[c][8] = e;
            else if (c < 8) this.modules[c + 1][8] = e;
            else this.modules[this.moduleCount - 15 + c][8] = e
        }
        for (c = 0; c < 15; c++) {
            e = !a && (b >> c & 1) == 1;
            if (c < 8) this.modules[8][this.moduleCount - c - 1] = e;
            else if (c < 9) this.modules[8][15 - c - 1 + 1] = e;
            else this.modules[8][15 - c - 1] = e
        }
...
for (var QRMode = {
    ...
    getBCHTypeInfo: function(a) {
        for (var d = a << 10; QRUtil.getBCHDigit(d) - QRUtil.getBCHDigit(QRUtil.G15) >= 0;) d ^= QRUtil.G15 << QRUtil.getBCHDigit(d) - QRUtil.getBCHDigit(QRUtil.G15);
    ...
    getErrorCorrectPolynomial: function(a) {
        for (var d = new QRPolynomial([1], 0), b = 0; b < a; b++) d = d.multiply(new QRPolynomial([1, QRMath.gexp(b)], 0));
        return d
    },
...
QRPolynomial.prototype = {
    ...
    mod: function(a) {
        ...
        for (var d = QRMath.glog(this.get(0)) - QRMath.glog(a.get(0)), b = Array(this.getLength()), c = 0; c < this.getLength(); c++) b[c] = this.get(c);
    ...
    a.fn.qrcode = function(d) {
        ...
        return this.each(function() {
            ...
            if (d.render == "canvas") {
                ...
                c.width = d.width;
                c.height = d.height;
                for (var e = c.getContext("2d"), f = d.width / b.getModuleCount(), j = d.height / b.getModuleCount(), g = 0; g < b.getModuleCount(); g++) for (var k = 0; k < b.getModuleCount(); k++) {
                ...
                for (j = 0; j < b.getModuleCount(); j++) {
                    ...
                    for (k = 0; k < b.getModuleCount(); k++) a("<td></td>").css("width", e + "px").css("background-color", b.isDark(j, k) ? d.darkColor : "#ffffff").appendTo(g)
                }
                b = c
            }
...
(function(a) {
    ...
    a.fn.jjmenu = function(j, g, k, o) {
        function s(t, y, E, G, B) {
            function N() {
                var Y = a(K).css("display") == "none" ? true : false,
                    m = false;
                ...
                var la = parseInt(a(K).outerHeight(), 10),
                    wa = Math.max(parseInt(a(K).outerWidth(), 10), 155),
                    Aa = a("body").height();
                a("body").width();
                ...
                if (B.orientation == "auto" && (Y || !za || a(K).attr("id").match("jjmenu_main_sub")) || B.orientation == "bottom") {
                    if (m + la > Aa) m = a(window).height() - la;
                    else {
                        if (B.yposition == "auto" && B.xposition == "left") m = m + a(G).outerHeight() + 1;
                        else if (a(K).attr("id").match("jjmenu_main_sub")) m -= 7;
                        m = m
                    }
            ...
            function ba(Y) {
                if (Y.hasOwnProperty("title") || _.defined(Y.customClass) && Y.customClass === "separator") {
                    ...
                    a(m).click(function() {
                        ...
                        if (a.isFunction(Y.action.log) && r) Y.action.log();
                        else r && GS.getGuts().logEvent("contextMenuClick", {
                            type: Y.action.type,
                            text: Y.title
                        })
                    });
            ...
            function L(Y) {
                ...
                case "gourl":
                    if (Y.target) {
                        window.open(ja(Y.url), Y.target).focus();
                        return false
        ...
        b.Session = function(f, j) {
            ...
            function k(K, Z) {
                ...
                (function() {
                    var ra = K.getOptions(),
                        Y;
                    for (Y = 0; Y < ra.length; Y++) da[ra[Y].getId()] = 0;
            ...
            function s(K) {
                var Z = null,
                    X;
                for (X = 0; X < y.length && Z == null; X++) if (y[X].getId() == K) Z = y[X];
            ...
            function r(K, Z) {
                if (typeof Z != "function") throw Error("Callback argument is not a function: " + Z);
                t.lock(function() {
                    if (B[K.getId()]) {
                        t.unlock();
                        Z(K, B[K.getId()])
...
(function(a) {
    function d() {
        ...
        this.deactivate = function(e) {
            if (c !== e) throw "SlickGrid.EditorLock.deactivate: specified editController is not the currently active one";
            c = null
        };
            ...
            Grid: function(c, e, f, j) {
                ...
                function k() {
                    var w = a("<div style='position:absolute; top:-10000px; left:-10000px; width:100px; height:100px; overflow:scroll;'></div>").appendTo("body"),
                        A = {
                            width: w.width() - w[0].clientWidth,
                            height: w.height() - w[0].clientHeight
                        };
                    w.remove();
                    return A
                }
                ...
                function v() {
                    ...
                    for (J = 0; J < f.length; J++) {
                        var aa = f[J] = a.extend({}, Wb, f[J]);
                        u[aa.id] = J;
                        ea = aa.columnFormatter ? aa.columnFormatter(aa) : "<span class='slick-column-name'>" + aa.name + "</span>";
                        ea = a("<div class='ui-state-default slick-header-column slick-header-column-" + aa.id + "' id='" + Fb + aa.id + "'/>").html(ea).width(aa.width - Gb).css({
                            left: "10000px",
                            "z-index": f.length - J
                        }).attr("title", aa.toolTip || "").data("fieldId", aa.id).appendTo($a);
                        aa.currentWidth = 0;
                    ...
                    $a.sortable({
                        ...
                        stop: function(w) {
                            if (j.editorLock.commitCurrentEdit()) {
                                for (var A = $a.sortable("toArray"), J = [], ea = 0; ea < A.length; ea++) J.push(f[N(A[ea].replace(Fb, ""))]);
                                X(J);
                ...
                function E() {
                    ...
                    ea.each(function(O, U) {
                        a(U);
                        x !== undefined && O < x || j.forceFitColumns && O >= F ? a("<div class='slick-resizable-handle' />").appendTo(U) : a("<div class='slick-resizable-handle'><span></span></div>").appendTo(U).bind("dragstart", function(T) {
                            ...
                            if (j.forceFitColumns) {
                                ...
                                for (w = O + 1; w < ea.length; w++) {
                                    A = f[w];
                                    if (A.resizable) {
                                        if (na !== null) if (A.maxWidth) na += A.maxWidth - A.previousWidth;
                                        else na = null;
                            ...
                            var ga, xa = Math.min(ta, Math.max(aa, T.pageX)) - J,
                                Ba;
                            if (xa < 0) {
                                Ba = xa;
                                for (w = O; w >= 0; w--) {
                            ...
                            for (w = 0; w < ea.length; w++) {
                                A = f[w];
                                T = a(ea[w]).outerWidth();
                                A.previousWidth !== T && A.rerenderOnResize && m();
                ...
                function G() {
                    function w(A) {
                        return {
                            start: {
                                row: Math.min(A.start.row, A.end.row),
                                cell: Math.min(A.start.cell, A.end.cell)
                            },
                            end: {
                                row: Math.max(A.start.row, A.end.row),
                                cell: Math.max(A.start.cell, A.end.cell)
                            }
                        }
                    }
                    La.bind("draginit", function(A, J) {
                        ...
                        ea = f[Fa(ea[0])];
                        if (ea.behavior == "move" || ea.behavior == "selectAndMove") J.mode = 1;
                        else if (j.enableCellRangeSelection) J.mode = 2;
                        else return false;
                        J.proxyOffsetX = 0;
                        J.proxyOffsetY = 0
                    }).bind("dragstart", function(A, J) {
                        if (!j.editorLock.commitCurrentEdit()) return false;
                        var ea = parseInt(a(A.target).closest(".slick-row").attr("row"), 10),
                            aa, ta, x = [];
                        ...
                        if (J.mode == 1) {
                            ...
                            if (J.draggedItemsContext.type == "playlist" && GS.page.activePage.playlist.isEditable(GS.user.UserID)) {
                                var F = GS.Models.Playlist.getOneFromCache(J.draggedItemsContext.data.playlistID),
                                    M = [];
                                ...
                                if (F && M.length) J.deleteAction = {
                                    label: M.length > 1 ? "SHORTCUTS_DELETE_FROM_PLAYLIST_COUNT" : "SHORTCUTS_DELETE_FROM_PLAYLIST",
                                    labelParams: {
                                        count: M.length
                                    },
                                    method: function() {
                            ...
                            if (J.draggedItemsType == "playlist" && J.draggedItems.length == 1) if ((F = GS.Models.Playlist.getOneFromCache(J.draggedItems[0].PlaylistID)) && F.UserID == GS.user.UserID) J.deleteAction = {
                                label: "SHORTCUTS_DELETE_PLAYLIST",
                                method: function() {
                                    GS.user.deletePlaylist(F.PlaylistID, true)
                                }
                            };
                            if (aa.Class.shortName === "NowPlayingController" && x.length) J.deleteAction = {
                                label: x.length > 1 ? "SHORTCUTS_DELETE_NOW_PLAYING_COUNT" : "SHORTCUTS_DELETE_NOW_PLAYING",
                                labelParams: {
                                    count: x.length
                                },
                                method: function() {
                            ...
                            if (J.draggedItemsContext.type == "user" && J.draggedItemsContext.data.userID == GS.user.UserID) J.deleteAction = {
                                label: J.draggedItems.length > 1 ? "SHORTCUTS_DELETE_FROM_LIBRARY_COUNT" : "SHORTCUTS_DELETE_FROM_LIBRARY",
                                labelParams: {
                                    count: J.draggedItems.length
                                },
                                method: function() {
                                    var T = [];
                            ...
                            aa = a("<div class='slick-reorder-proxy'/>").css({
                                position: "absolute",
                                zIndex: "99999",
                                "min-height": "50px",
                                "padding-right": "50px"
                            }).appendTo("body").mousewheel(_.globalDragProxyMousewheel);
                            if (j.dragProxy) j.isFilter && U ? aa.html(j.dragProxy(U)) : aa.html(j.dragProxy(J.draggedItems));
                            else aa.html('<div class="status"></div><span class="info"><span class="text">' + J.draggedItems.length + "</span></span>");
                        ...
                        if (J.mode == 1) {
                            ...
                            _.forEach(J.drop, function(F) {
                                ...
                                if (!ea) if (a(F).within(A.clientX, A.clientY).length > 0) if (a(F).data("ignoreForOverDrop")) aa = true;
                                else {
                                    aa = false;
                                    ea = true
                                }
                        ...
                        if (J.mode == 2) {
                            ...
                            if (jb(ta.row, ta.cell)) {
                                ...
                                a(J.proxy).css({
                                    top: ta.top,
                                    left: ta.left,
                                    height: x.bottom - ta.top - 2,
                                    width: x.right - ta.left - 2
                                })
                            }
                        }
                    }).bind("dragend", function(A, J) {
                        a(J.proxy).remove();
                        var ea = Na.within(A.clientX, A.clientY).length > 0;
                ...
                function ba() {
                    ...
                    if (aa !== 0) {
                        ...
                        for (w = 0; w < F.length; w++) {
                            ...
                            if (x && J + M > A.maxWidth) M = A.maxWidth - J;
                            aa -= M;
                            ta -= J;
                ...
                function ja(w, A) {
                    ...
                    if (J != null) $a.children().eq(J).addClass("slick-header-column-sorted").find(".slick-sort-indicator").addClass(H ? "slick-sort-indicator-asc" : "slick-sort-indicator-desc")
                }
                function K() {
                    return n.concat()
                }
                ...
                function da(w, A) {
                    var J = Ua;
                    ub = Math.min(yb - 1, Math.floor(w / tb));
                    Ua = Math.round(ub * Kb);
                    var ea = w - Ua;
                    if (Ua != J) {
                        var aa = ua(ea);
                ...
                function Aa(w) {
                    if (Ma[w]) {
                        a(Ma[w]).children().each(function(A) {
                            var J = f[A];
                            if (w === Ka && A === Oa && Ea) Ea.loadValue(Ra(Ka));
                            else this.innerHTML = Ra(w) ? ra(J)(w, A, Ra(w)[J.field], J, Ra(w)) : ""
                        });
                        Q(w)
                    }
                }
                ...
                function S() {
                    var w = Va() + (j.enableAddRow ? 1 : 0) + (j.leaveSpaceForNewRows ? Cb - 1 : 0),
                        A = gb,
                        J = Va();
                    ...
                    w = Ya + Ua <= ab - Za;
                    if (ab == 0 || Ya == 0) ub = Ua = 0;
                    else w ? da(Ya + Ua) : da(ab - Za);
                    gb != A && j.autoHeight && za()
                }
                function ua() {
                    return {
                        top: Math.floor((Ya + Ua) / j.rowHeight),
                        bottom: Math.ceil((Ya + Ua + Za) / j.rowHeight) - 1
                    }
                }
                function pa() {
                ...
                function ma() {
                    ...
                    for (J = A.top; J <= A.bottom; J++) if (!Ma[J]) {
                        ...
                        U.push("<div class='ui-widget-content " + Ba + "' row='" + T + "' style='top:" + (j.rowHeight * T - Ua + zb) + "px' " + xa + ">");
                        ga = Ba = 0;
                ...
                function va() {
                    ...
                    if (A) {
                        ...
                        V && clearTimeout(V);
                        if (Math.abs(Vb - Ya) < Za) ma();
                        else V = setTimeout(ma, 50);
                        Da.onViewportChanged && Da.onViewportChanged()
                    }
                }
                function ya() {
                ...
                function Ha(w) {
                    if (!(Da.onKeyDown && !j.editorLock.isActive() && Da.onKeyDown(w, Ka, Oa))) if (!w.shiftKey && !w.altKey && !w.ctrlKey && !w.metaKey) if (w.which == 27) {
                        ...
                        Xb()
                    } else if (w.which == 37) ac();
                    else if (w.which == 39) bb();
                    else if (w.which == 38) Zb();
                    else if (w.which == 40) Pb();
                    else if (w.which == 9) Qb();
                    else if (w.which == 13) {
                        if (j.editable) if (Ea) Ka === q() ? Pb() : Nb();
                        else j.editorLock.commitCurrentEdit() && Mb()
                    } else return;
                    else if (w.which == 9 && w.shiftKey && !w.ctrlKey && !w.metaKey && !w.altKey) hc();
                    else return;
                    w.stopPropagation();
                    w.preventDefault();
                    try {
                ...
                function Pa(w) {
                    ...
                    if (A.length !== 0) if (!(Ja === A[0] && Ea !== null)) {
                        ...
                        if (!(a.isFunction(j.isSelectable) && !j.isSelectable(x))) {
                            ...
                            if (x && (ta.behavior === "selectAndMove" || ta.behavior === "select" || w.ctrlKey || w.metaKey || w.shiftKey)) {
                                if (aa = j.editorLock.commitCurrentEdit()) {
                                    ta = K();
                                    var M = a.inArray(J, ta);
                                    if (J == ta && w.timeStamp - F > 750) w.ctrlKey = true;
                                    if (j.disableMultiSelect || !w.ctrlKey && !w.metaKey && !w.shiftKey) ta = ta.length === 1 && ta[0] == J ? [] : [J];
                                    else if (M === -1 && (w.ctrlKey || w.metaKey)) ta.push(J);
                                    else if (M !== -1 && (w.ctrlKey || w.metaKey)) ta = a.grep(ta, function(U) {
                                        return U !== J
                                    });
                ...
                function sb(w) {
                    ...
                    if (A.length !== 0) if (!(Ja === A[0] && Ea !== null)) {
                        ...
                        A = Fa(A[0]);
                        var ea = null;
                        if (Ra(J) && Da.onDblClick)(ea = j.editorLock.commitCurrentEdit()) && Da.onDblClick(w, J, A) && w.preventDefault();
                ...
                function pb() {
                    ...
                    if (a.browser.msie && parseInt(a.browser.version) < 8) {
                        Ja.setActive();
                        var w = a(Ja).position().left,
                            A = w + a(Ja).outerWidth(),
                            J = Na.scrollLeft(),
                            ea = J + Na.width();
                        if (w < J) Na.scrollLeft(w);
                        else A > ea && Na.scrollLeft(Math.min(w, A - Na[0].clientWidth))
                    } else Ja.focus()
                }
                ...
                function dc(w, A) {
                    ...
                    if (Ja !== null) {
                        ...
                        if (j.editable && A && ec(Ka, Oa)) {
                            clearTimeout(R);
                            if (j.asyncEditorLoading) R = setTimeout(Mb, j.asyncEditorLoadDelay);
                            else Mb()
                        } else pb();
                ...
                function eb() {
                    if (Ea) {
                        ...
                        else if (window.getSelection)(w = window.getSelection()) && w.removeAllRanges && w.removeAllRanges();
                ...
                function Mb() {
                    if (Ja) {
                        ...
                        clearTimeout(R);
                        if (ec(Ka, Oa)) if (Da.onBeforeEditCell && Da.onBeforeEditCell(Ka, Oa, Ra(Ka)) === false) pb();
                        else {
                            ...
                            var w = f[Oa],
                                A = Ra(Ka);
                            Ea = new(w.editor || j.editorFactory && j.editorFactory.getEditor(w))({
                                grid: Da,
                                gridPosition: Db(Wa[0]),
                                position: Db(Ja),
                                container: Ja,
                                column: w,
                                item: A || {},
                ...
                function Db(w) {
                    var A = {
                        ...
                        bottom: 0,
                        right: 0,
                        width: a(w).outerWidth(),
                        height: a(w).outerHeight(),
                        visible: true
                    };
                    A.bottom = A.top + A.height;
                    A.right = A.left + A.width;
                    for (var J = w.offsetParent;
                    (w = w.parentNode) != document.body;) {
                ...
                function Ob(w, A) {
                    var J = w * j.rowHeight,
                        ea = (w + 1) * j.rowHeight - Za + (mb ? b.height : 0);
                ...
                function xb(w, A, J) {
                    ...
                    if (Ja && j.enableCellNavigation) if (j.editorLock.commitCurrentEdit()) {
                        var aa = Ma[Ka + w],
                            ta = aa && Oa + A >= 0 ? a(aa).children().eq(Oa + A).filter(ea) : null;
                        if (ta && !ta.length) {
                ...
                function gc(w, A, J) {
                    if (!(w > Va() || w < 0 || A >= f.length || A < 0)) if (!(!j.enableCellNavigation || f[A].unselectable)) if (j.editorLock.commitCurrentEdit()) {
                        Ob(w, false);
                        var ea = null;
                            ...
                            if (J.valid) {
                                if (Ka < Va()) {
                                    J = {
                                        ...
                                        cell: Oa,
                                        editor: Ea,
                                        serializedValue: Ea.serializeValue(),
                                        prevSerializedValue: qb,
                                        execute: function() {
                                ...
                                a(Ja).stop(true, true).effect("highlight", {
                                    color: "red"
                                }, 300);
                ...
                var ic = {
                    ...
                    Jb, ab, gb, tb, yb, Kb, ub = 0,
                    Ua = 0,
                    zb = 0,
                    Eb = 1,
                    Wa, Fb = "slickgrid_" + Math.round(1E6 * Math.random()),
                    Da = this,
                    vb, $a, hb, jc, Na, La, Za, $b, mb, nb, Gb, pc, Tb, Ib, ob, Ka, Oa, Ja = null,
                    Ea = null,
                    qb, Ub, Ma = {},
                    cb = 0,
                    Cb, ib = 0,
                ...
                (function() {
                    ...
                    Ub = {
                        commitCurrentEdit: mc,
                        cancelCurrentEdit: nc
                    };
                ...
                a.extend(this, {
                    ...
                    updateCell: function(w, A) {
                        if (Ma[w]) {
                            ...
                            if (J.length !== 0) {
                                var ea = f[A],
                                    aa = Ra(w);
                                if (Ea && Ka === w && Oa === A) Ea.loadValue(aa);
                                else {
                    ...
                    updateRowCount: S,
                    getCellFromPoint: kb,
                    getCellFromEvent: function(w) {
                        w = a(w.target).closest(".slick-cell", La);
                        if (!w.length) return null;
                        return {
                            row: w.parent().attr("row") | 0,
                            cell: Fa(w[0])
                        }
                    },
                    getCurrentCell: fc,
            ...
            Data: {
                DataView: function() {
                    ...
                    function e(X, da) {
                        ...
                        Object.prototype.toString = typeof X == "function" ? X : function() {
                            return this[X]
                        };
                        da === false && k.reverse();
                        k.sort();
                    ...
                    return {
                        ...
                        onRowCountChanged: ja,
                        onRowsChanged: K,
                        onPagingInfoChanged: Z
                    }
                }
            }
        }
...
function rstr2any(a, d) {
    var b = d.length,
        c, e, f, j, g, k = Array(Math.ceil(a.length / 2));
    for (c = 0; c < k.length; c++) k[c] = a.charCodeAt(c * 2) << 8 | a.charCodeAt(c * 2 + 1);
    var o = Math.ceil(a.length * 8 / (Math.log(d.length) / Math.log(2))),
        s = Array(o);
    for (e = 0; e < o; e++) {
        g = [];
...
function binl_md5(a, d) {
    ...
    for (var b = 1732584193, c = -271733879, e = -1732584194, f = 271733878, j = 0; j < a.length; j += 16) {
        ...
        b = md5_ff(b, c, e, f, a[j + 8], 7, 1770035416);
        ...
        f = md5_gg(f, b, c, e, a[j + 10], 9, 38016083);
        ...
        e = md5_hh(e, f, b, c, a[j + 11], 16, 1839030562);
        ...
        c = md5_hh(c, e, f, b, a[j + 2], 23, -995338651);
        ...
        b = md5_ii(b, c, e, f, a[j + 4], 6, -145523070);
...
function rstr2any(a, d) {
    var b = d.length,
        c = [],
        e, f, j, g, k = Array(Math.ceil(a.length / 2));
    ...
    a.GrowingInput = function(b, c) {
        ...
        var g = this,
            ...
            o = function() {
                ...
                c.maxWidth ? b.width(Math.min(c.maxWidth, k(s))) : b.width(k(s));
                return g
            };
        this.resize = o;
        (function() {
...
(function(a) {
    a.TextboxList = function(e, f) {
        ...
        var y = this,
            ...
            G = function() {
                t.endEditableBit && B("editable", null, {
                    tabIndex: j.tabIndex
                }).inject(k);
                ra("bitAdd", W, true);
                ra("bitRemove", W, true);
                a(document).click(function(P) {
                    ...
                    if (s && o) {
                        var la = o.is("editable") ? o.getCaret() : null,
                            wa = o.getValue()[1],
                            Aa = !! a.map(["shift", "alt", "meta", "ctrl"], function(C) {
                                return P[C]
                            }).length || o.is("editable") && o.isSelected(),
                            za = function() {
                                P.stopPropagation();
                                P.preventDefault()
                            };
            ...
            B = function(P, la, wa) {
                if (P == "box") {
                    if (d(t.max) && k.children("." + t.prefix + "-bit-box").length + 1 > t.max) return false;
        ...
        this.plugins = [];
        (function() {
            j = e.css("display", "none").attr("autocomplete", "off").focus(ja);
    ...
    a.TextboxListBit = function(e, f, j, g) {
        var k, o, s, q, r, v = false,
            t = c(e),
            y = a.extend(true, e == "box" ? {
                deleteButton: true
            } : {
                tabIndex: null,
                growing: true,
        ...
        if (e == "editable") {
            this.getCaret = function() {
                ...
                if (Z.createTextRange) {
                    ...
                    if (X.text === "") return Z.value.length;
        ...
        (function() {
            ...
            o = a("<li />").addClass(s).addClass(q).data("textboxlist:bit", E).hover(function() {
                o.addClass(s + "-hover").addClass(q + "-hover")
            }, function() {
            ...
            if (e == "box") {
                ...
                y.growing && new a.GrowingInput(k, y.growingOptions);
                k.focus(function() {
                    G(true)
                }).blur(function() {
                    B(true);
...
(function() {
    $.TextboxList.Autocomplete = function(d, b) {
        var c, e, f, j, g = [],
            ...
            ba = function(ra, Y) {
                var m = ra[3] ? '<div class="outer"><img height="30" width="30" src="' + ra[3] + '" /><span class="username">' + ra[1] + "</span></div>" : ra[1],
                    P = $(ra[3] ? '<li class="' + c + '-result hasImage" />' : '<li class="' + c + '-result" />').html(m).data("textboxlist:auto:value", ra);
                P.appendTo(j);
                if (E.highlight) $(E.highlightSelector ? P.find(E.highlightSelector) : P).each(function() {
                    $(this).html() && e.highlight($(this), Y, E.insensitive, c + "-highlight")
                });
            ...
            da = function() {
                var ra = s.data("textboxlist:auto:value"),
                    Y = d.create("box", ra.slice(0, 3));
                if (Y) {
                    Y.autoValue = ra;
            ...
            W = function(ra) {
                ...
                case 38:
                    Y();
                    !E.onlyFromValues && s && s.get(0) === j.find(":first").get(0) ? Z() : X("prev");
                    break;
                case 40:
                    Y();
        ...
        (function() {
            d.addEvent("bitEditableAdd", G).addEvent("bitEditableFocus", B).addEvent("bitEditableBlur", L).setOptions({
                bitsOptions: {
                    editable: {
                        addKeys: false,
                        stopEnter: false
...
var googleOpenIDPopup = {
    ...
    getWindowInnerSize: function() {
        ...
        if ("innerWidth" in window) {
            ...
            if ("BackCompat" === window.document.compatMode && "body" in window.document) b = window.document.body;
            else if ("documentElement" in window.document) b = window.document.documentElement;
            if (b !== null) {
                a = b.offsetWidth;
                d = b.offsetHeight
            }
    ...
    getCenteredCoords: function(a, d) {
        var b = this.getWindowInnerSize(),
            c = this.getParentCoords(),
            e = c[0] + Math.max(0, Math.floor((b[0] - a) / 2));
    ...
    createPopupOpener: function(a) {
        var d = null,
            ...
            f = "identifier" in a ? e ? encodeURIComponent(a.identifier) : a.identifier : this.constants.openidSpec.identifier_select,
            j = "identity" in a ? e ? encodeURIComponent(a.identity) : a.identity : this.constants.openidSpec.identifier_select,
            g = "namespace" in a ? e ? encodeURIComponent(a.namespace) : a.namespace : this.constants.openidSpec.namespace2,
            k = "onOpenHandler" in a && "function" === typeof a.onOpenHandler ? a.onOpenHandler : this.darkenScreen,
            o = "onCloseHandler" in a && "function" === typeof a.onCloseHandler ? a.onCloseHandler : null,
            s = "returnToUrl" in a ? a.returnToUrl : null,
            q = "realm" in a ? a.realm : null,
            r = "opEndpoint" in a ? a.opEndpoint : null,
            v = "extensions" in a ? a.extensions : null,
            t = function() {
                if (!b || b.closed) {
                    b = null;
                    o && o();
        ...
        return {
            popup: function(y, E) {
                ...
                if (null === r || null === s) G = void 0;
                    ...
                    if (q !== null) B += "&openid.realm=" + (e ? encodeURIComponent(q) : q);
                    if (v !== null) {
                        G = B;
                        B = "";
...
window.ZeroClipboard.Client.prototype = {
    ...
    getHTML: function(a, d) {
        ...
        } else b += '<embed id="' + this.movieId + '" src="' + ZeroClipboard.moviePath + '" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="' + a + '" height="' + d + '" name="' + this.movieId + '" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="' + c + '" wmode="transparent" />';
        return b
    },
    hide: function() {
    ...
    receiveEvent: function(a, d) {
        ...
        if (this.handlers[a]) for (var c = 0, e = this.handlers[a].length; c < e; c++) {
            ...
            if (typeof f == "function") f(this, d);
            else if (typeof f == "object" && f.length == 2) f[0][f[1]](this, d);
            else typeof f == "string" && window[f](this, d)
        }
    }
};
(function(a) {
    var d = function(b) {
            var c = 65,
                ...
                k = function(C, S) {
                    a(S).data("colorpicker").selector.css("backgroundColor", "#" + za(Aa({
                        h: C.h,
                        s: 100,
                        b: 100
                    })));
                    a(S).data("colorpicker").selectorIndic.css({
                        left: parseInt(150 * C.s / 100, 10),
                        top: parseInt(150 * (100 - C.b) / 100, 10)
                    })
                },
                o = function(C, S) {
                ...
                v = function(C) {
                    ...
                    if (this.parentNode.className.indexOf("_hex") > 0) {
                        ...
                        pa = wa(la(pa));
                        ua.color = ua = pa
                    } else if (this.parentNode.className.indexOf("_hsb") > 0) S.data("colorpicker").color = ua = P({
                        ...
                        ua.color = ua = wa({
                            r: Math.min(255, Math.max(0, pa.r)),
                            g: Math.min(255, Math.max(0, pa.g)),
                            b: Math.min(255, Math.max(0, pa.b))
                        })
                    }
                    if (C) {
                        f(ua, S.get(0));
                ...
                B = function(C) {
                    v.apply(C.data.field.get(0), [true]);
                ...
                K = function(C) {
                    v.apply(C.data.cal.data("colorpicker").fields.eq(6).val(parseInt(100 * (150 - Math.max(0, Math.min(150, C.pageY - C.data.pos.top))) / 150, 10)).end().eq(5).val(parseInt(100 * Math.max(0, Math.min(150, C.pageX - C.data.pos.left)) / 150, 10)).get(0), [C.data.preview]);
                    return false
                },
                Z = function(C) {
                    f(C.data.cal.data("colorpicker").color, C.data.cal.get(0));
                ...
                ra = function() {
                    ...
                    C.data("colorpicker").onShow.apply(this, [C.get(0)]) != false && C.show();
                ...
                P = function(C) {
                    return {
                        h: Math.min(360, Math.max(0, C.h)),
                        s: Math.min(100, Math.max(0, C.s)),
                        b: Math.min(100, Math.max(0, C.b))
                    }
                },
                la = function(C) {
                ...
                wa = function(C) {
                    ...
                    S.h = C.r == C.g && C.g == C.b ? 0 : C.r >= C.g && C.g >= C.b ? 60 * (C.g - C.b) / (C.r - C.b) : C.g >= C.r && C.r >= C.b ? 60 + 60 * (C.g - C.r) / (C.g - C.b) : C.g >= C.b && C.b >= C.r ? 120 + 60 * (C.b - C.r) / (C.g - C.r) : C.b >= C.g && C.g >= C.r ? 180 + 60 * (C.b - C.g) / (C.b - C.r) : C.b >= C.r && C.r >= C.g ? 240 + 60 * (C.r - C.g) / (C.b - C.g) : C.r >= C.b && C.b >= C.g ? 300 + 60 * (C.r - C.b) / (C.r - C.g) : 0;
                    S.h = Math.round(S.h);
                    return S
                },
                Aa = function(C) {
                    var S = {},
                        ua = Math.round(C.h),
                        pa = Math.round(C.s * 255 / 100);
                    C = Math.round(C.b * 255 / 100);
                    if (pa == 0) S.r = S.g = S.b = C;
                    else {
                        pa = (255 - pa) * C / 255;
                        var Q = (C - pa) * (ua % 60) / 60;
                        if (ua == 360) ua = 0;
            ...
            return {
                init: function(C) {
                    C = a.extend({}, e, C || {});
                    if (typeof C.color == "string") C.color = wa(la(C.color));
                    else if (C.color.r != b && C.color.g != b && C.color.b != b) C.color = wa(C.color);
                    else if (C.color.h != b && C.color.s != b && C.color.b != b) C.color = P(C.color);
                    else return this;
                    C.origColor = C.color;
                    return this.each(function() {
                ...
                setColor: function(C) {
                    if (typeof C == "string") C = wa(la(C));
                    else if (C.r != b && C.g != b && C.b != b) C = wa(C);
                    else if (C.h != b && C.s != b && C.b != b) C = P(C);
                    else return this;
                    return this.each(function() {
                        if (a(this).data("colorpickerId")) {
    ...
    a.fn.extend({
        ColorPicker: d.init,
        ColorPickerHide: d.hide,
        ColorPickerShow: d.show,
        ColorPickerSetColor: d.setColor
    })
})($);
(function(a, d) {
...
(function(a) {
    EYE.extend({
        ...
        getSize: function(d) {
            var b = parseInt(jQuery.curCSS(d, "width"), 10),
                c = parseInt(jQuery.curCSS(d, "height"), 10),
                e = 0,
                f = 0;
        ...
        getClient: function(d) {
            ...
            if (d) {
                ...
                d = window.innerHeight || self.innerHeight || d && d.clientHeight || document.body.clientHeight
            }
            return {
                w: b,
                h: d
        ...
        getMargins: function(d, b) {
            var c = jQuery.curCSS(d, "marginTop") || "",
                e = jQuery.curCSS(d, "marginRight") || "",
                f = jQuery.curCSS(d, "marginBottom") || "",
                j = jQuery.curCSS(d, "marginLeft") || "";
            return b ? {
                t: parseInt(c, 10) || 0,
                r: parseInt(e, 10) || 0,
                b: parseInt(f, 10) || 0,
        ...
        getPadding: function(d, b) {
            var c = jQuery.curCSS(d, "paddingTop") || "",
                e = jQuery.curCSS(d, "paddingRight") || "",
                f = jQuery.curCSS(d, "paddingBottom") || "",
                j = jQuery.curCSS(d, "paddingLeft") || "";
            return b ? {
                t: parseInt(c, 10) || 0,
                r: parseInt(e, 10) || 0,
                b: parseInt(f, 10) || 0,
        ...
        getBorder: function(d, b) {
            var c = jQuery.curCSS(d, "borderTopWidth") || "",
                e = jQuery.curCSS(d, "borderRightWidth") || "",
                f = jQuery.curCSS(d, "borderBottomWidth") || "",
        ...
        getExtraWidth: function(d) {
            if (a.boxModel) return (parseInt(a.curCSS(d, "paddingLeft")) || 0) + (parseInt(a.curCSS(d, "paddingRight")) || 0) + (parseInt(a.curCSS(d, "borderLeftWidth")) || 0) + (parseInt(a.curCSS(d, "borderRightWidth")) || 0);
            return 0
        },
        ...
        isChildOf: function(d, b, c) {
            ...
            if (d.contains && !a.browser.safari) return d.contains(b);
        ...
        centerEl: function(d, b) {
            var c = EYE.getScroll(),
                e = EYE.getSize(d);
            if (!b || b == "vertically") a(d).css({
                top: c.t + (Math.min(c.h, c.ih) - e.hb) / 2 + "px"
            });
            if (!b || b == "horizontally") a(d).css({
                left: c.l + (Math.min(c.w, c.iw) - e.wb) / 2 + "px"
            })
        }
    });
...
(function(a) {
    EYE.register(function() {
        a("#colorpickerHolder").ColorPicker({
            flat: true
        });
        a("#colorpickerHolder2").ColorPicker({
            flat: true,
            color: "#00ff00",
        ...
        a("#colorSelector2").bind("click", function() {
            a("#colorpickerHolder2").stop().animate({
                height: d ? 0 : 173
            }, 500);
            d = !d
        });
        a("#colorpickerField1").ColorPicker({
            onSubmit: function(b, c) {
...
(function() {
    ...
    function b(j) {
        ...
        k && s.push(k);
        o && s.push(o);
        return s.length > 0 ? g.apply(null, s) : g.call()
    }
    function c(j, g, k) {
        if (k) {
            e[k] || (e[k] = {});
    ...
    a.fn = a.prototype = {
        ...
        api: function(j, g) {
            ...
            var k = this.element,
                o = k.id != "" ? k.id : null,
                s = !(g && g.constructor && g.call && g.apply) ? g : null,
                q = g && g.constructor && g.call && g.apply ? g : null;
            q && c(j, q, o);
            d(j, s, k);
            return this
        },
...
OAuth.setProperties(OAuth, {
    ...
    setParameter: function(a, d, b) {
        ...
        if (c instanceof
        Array) {
            for (a = 0; a < c.length; ++a) if (c[a][0] == d) if (b === undefined) c.splice(a, 1);
            else {
                c[a][1] = b;
                b = undefined
            }
...
OAuth.setProperties(OAuth.SignatureMethod, {
    ...
    getBaseString: function(a) {
        ...
        return OAuth.percentEncode(a.method.toUpperCase()) + "&" + OAuth.percentEncode(OAuth.SignatureMethod.normalizeUrl(d)) + "&" + OAuth.percentEncode(OAuth.SignatureMethod.normalizeParameters(b))
    },
    ...
    normalizeParameters: function(a) {
        ...
        for (var b = 0; b < d.length; ++b) {
            var c = d[b];
            c[0] != "oauth_signature" && a.push([OAuth.percentEncode(c[0]) + " " + OAuth.percentEncode(c[1]), c])
        }
        a.sort(function(e, f) {
            if (e[0] < f[0]) return -1;
            if (e[0] > f[0]) return 1;
